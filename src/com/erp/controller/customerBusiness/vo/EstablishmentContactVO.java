...
public class EstablishmentContactVO {
	...
	private String sex;
	private String possie;//职务
	private String mobile;//手机
	private String phone;//电话
	private String email;//emaill
	private String im;//qq
	private String mark;//备注
	private String isMain = "N";//主要
	...
	public String toString() {
		return "EstablishmentContactVO [id=" + id + ", estId=" + estId + ", contactName=" + contactName + ", sex=" + sex
				+ ", possie=" + possie + ", mobile=" + mobile + ", phone=" + phone + ", email=" + email + ", im=" + im
				+ ", mark=" + mark + ", isMain=" + isMain + ", tmpCode=" + tmpCode + "]";
	}
