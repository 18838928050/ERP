 ...
 *******************************************************************
 @说明：
 *******************************************************************/
public class waixieqichuqiankuanAction {
	private File wmc;
		...
		for (int index = 0; index < sheet_size; index++) {
			...
			for (int i = 1; i < sheet.getRows(); i++) {
				...
				for (int j = 0; j < sheet.getColumns(); j++) {
					...
					String estCodeString = establishmentDAO.findEstMaxCodeLikeT();
					...
					establishmentVO.setEstType("COOPERATOR");
