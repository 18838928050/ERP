...
public class tuihuodanshenheAction extends BaseAction<PurchaseBillVTOw> {
	TuihuodanshenheMgr tuihuodanshenheMgr = new TuihuodanshenheMgr();

	public String findAll(){
		long tallySetId = 2l;
		model.setPurchaseBillVOs(tuihuodanshenheMgr.findPbs(tallySetId));
