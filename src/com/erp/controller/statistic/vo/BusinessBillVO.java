...
public class BusinessBillVO {
	...
	private Date orderDate = new Date();//订货日期
	private Date deliverDate = new Date();//结账日期 交付日期
	private Date checkDate = new Date();//检查日期
	private String content;
	private BigDecimal amount = new BigDecimal(0);
	private BigDecimal cost = new BigDecimal(0);//总额
	...
	private String designerNameStr;//跟单员
