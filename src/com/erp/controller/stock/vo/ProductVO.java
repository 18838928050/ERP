...
public class ProductVO {
	...
	private String productName;//材料类别
	private String pnSpell;//材料编号
	private String patria;
	private String unit;//单位
	private String minorUnit;
	private String unitConvert;
	private long productTypeId = 0L;
	private String barCode;//数量
	private BigDecimal maxLimit = new BigDecimal(0);//最高库存
	private BigDecimal minLimit = new BigDecimal(0);//安全库存
