...
public class tuihuodanchukuMgr {
...
TallySetDAOw tallySetDAO=new TallySetDAOw();
	public List findPbs(long tallySetId) {
		return purchaseBillDAO.findPbs(tallySetId); 
	}
	...
	public void setcaigoudanruku(long id) {
		 purchaseBillDAO.setcaigoudanruku(id);
	}
	public void setcaigoudanfanruku(long id) {
		 purchaseBillDAO.setcaigoudanfanruku(id);
		
	}
	public void settuihuodanchuku(long id) {
		purchaseBillDAO.settuihuodanchuku(id);
		
	}
	public void tuihuodanfanchuku(long id) {
purchaseBillDAO.settuihuodanfanchuku(id);		
	}
}
