...
public class AdjustBillItemVO {
	...
	public String toString() {
		return "AdjustBillItemVO [id=" + id + ", billId=" + billId
				+ ", businessBillId=" + businessBillId + ", businessBillCode="
				+ businessBillCode + ", content=" + content + ", orderDate="
				+ orderDate + ", totalCost=" + totalCost + ", remainCost="
				+ remainCost + ", thisCost=" + thisCost + "]";
	}
