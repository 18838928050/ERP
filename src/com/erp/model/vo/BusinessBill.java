...
public class BusinessBill {
	...
	public String toString() {
		return "BusinessBill [id=" + id + ", billCode=" + billCode + ", clientId=" + clientId + ", linkman=" + linkman
				+ ", phone=" + phone + ", address=" + address + ", orderDate=" + orderDate + ", deliverDate="
				+ deliverDate + ", checkDate=" + checkDate + ", content=" + content + ", amount=" + amount + ", cost="
				+ cost + ", square=" + square + ", lengM=" + lengM + ", lengCm=" + lengCm + ", bankAccountId="
				+ bankAccountId + ", payModeId=" + payModeId + ", imprest=" + imprest + ", favCost=" + favCost
				+ ", managerId=" + managerId + ", managerName=" + managerName + ", departmentId=" + departmentId
				+ ", setupRequire=" + setupRequire + ", ladingRequire=" + ladingRequire + ", mark=" + mark
				+ ", contractCode=" + contractCode + ", tallySetId=" + tallySetId + ", introducerId=" + introducerId
				+ ", introducerName=" + introducerName + ", designType=" + designType + ", designerIdStr="
				+ designerIdStr + ", designerNameStr=" + designerNameStr + ", followerIdStr=" + followerIdStr
				+ ", followerNameStr=" + followerNameStr + ", createrId=" + createrId + ", createrName=" + createrName
				+ ", createTime=" + createTime + ", updateTime=" + updateTime + ", modifierId=" + modifierId
				+ ", modifierName=" + modifierName + ", modifyTime=" + modifyTime + ", sourType=" + sourType + "]";
	}
}