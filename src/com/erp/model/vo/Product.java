...
public class Product {
	...
	private BigDecimal inpric = new BigDecimal(0);

	public String toString() {
		return "Product [id=" + id + ", productCode=" + productCode + ", productName=" + productName + ", pnSpell="
				+ pnSpell + ", patria=" + patria + ", unit=" + unit + ", minorUnit=" + minorUnit + ", unitConvert="
				+ unitConvert + ", productTypeId=" + productTypeId + ", barCode=" + barCode + ", maxLimit=" + maxLimit
				+ ", minLimit=" + minLimit + ", enabled=" + enabled + ", mark=" + mark + ", saleCost1=" + saleCost1
				+ ", saleCost2=" + saleCost2 + ", saleCost3=" + saleCost3 + ", saleCost4=" + saleCost4 + ", attachFile="
				+ attachFile + ", inpric=" + inpric + "]";
	}

	public BigDecimal getInpric() {
		return inpric;
	}

	public void setInpric(BigDecimal inpric) {
		this.inpric = inpric;
	}
