...
public class BusinessBillVO {
	
	public static final String CODE_RULE = "BUSINESS_BILL";
	private long id;
	private String billCode;//编号
	private long clientId = 0L;//订货单位
	private String linkman;
	private String phone;//手机
	private String address;
	private Date orderDate = new Date();//交货日期
	private Date deliverDate = new Date();//订货日期
	//
	...
	private String setupRequire;//安装要求
	private String ladingRequire;//提货要求
	private String mark;
	...
	public String toString() {
		return "BusinessBillVO [id=" + id + ", billCode=" + billCode
				+ ", clientId=" + clientId + ", linkman=" + linkman
				+ ", phone=" + phone + ", address=" + address + ", orderDate="
				+ orderDate + ", deliverDate=" + deliverDate + ", checkDate="
				+ checkDate + ", content=" + content + ", amount=" + amount
				+ ", cost=" + cost + ", square=" + square + ", lengM=" + lengM
				+ ", lengCm=" + lengCm + ", bankAccountId=" + bankAccountId
				+ ", payModeId=" + payModeId + ", imprest=" + imprest
				+ ", favCost=" + favCost + ", managerId=" + managerId
				+ ", managerName=" + managerName + ", departmentId="
				+ departmentId + ", setupRequire=" + setupRequire
				+ ", ladingRequire=" + ladingRequire + ", mark=" + mark
				+ ", contractCode=" + contractCode + ", tallySetId="
				+ tallySetId + ", introducerId=" + introducerId
				+ ", introducerName=" + introducerName + ", designType="
				+ designType + ", designerIdStr=" + designerIdStr
				+ ", designerNameStr=" + designerNameStr + ", followerIdStr="
				+ followerIdStr + ", followerNameStr=" + followerNameStr
				+ ", createrId=" + createrId + ", createrName=" + createrName
				+ ", createTime=" + createTime + ", updateTime=" + updateTime
				+ ", modifierId=" + modifierId + ", modifierName="
				+ modifierName + ", modifyTime=" + modifyTime + ", sourType="
				+ sourType + "]";
	}
