...
public class MakeTypeVO  {
	...
	public String toString() {
		return "MakeTypeVO [id=" + id + ", typeName=" + typeName
				+ ", parentId=" + parentId + ", parentIdStr=" + parentIdStr
				+ ", tnSpell=" + tnSpell + ", workCenterId=" + workCenterId
				+ ", enabled=" + enabled + ", unit=" + unit + ", type=" + type
				+ ", sequCode=" + sequCode + ", autoStoc=" + autoStoc
				+ ", lossRate=" + lossRate + "]";
	}
