...
public class FeeBillVO {
	...
	public String toString() {
		return "FeeBillVO [id=" + id + ", billCode=" + billCode + ", feeDate=" + feeDate
				+ ", departmentId=" + departmentId + ", payModeId=" + payModeId
				+ ", bankAccountId=" + bankAccountId + ", cost=" + cost + ", managerId="
				+ managerId + ", managerName=" + managerName + ", mark=" + mark + ", examined="
				+ examined + ", examinerId=" + examinerId + ", examinerName=" + examinerName
				+ ", createrId=" + createrId + ", createrName=" + createrName + ", enabled="
				+ enabled + ", disableManId=" + disableManId + ", updateTime=" + updateTime
				+ ", tallySetId=" + tallySetId + ", attachFile=" + attachFile + ", createTime="
				+ createTime + ", examineTime=" + examineTime + ", receiverName=" + receiverName
				+ ", examSms=" + examSms + "]";
	}
