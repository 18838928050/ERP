...
public class BusinessBillItemVO {
	...
	public String toString() {
		return "BusinessBillItemVO [id=" + id + ", billId=" + billId
				+ ", makeRequire=" + makeRequire + ", amount=" + amount
				+ ", unitPrice=" + unitPrice + ", cost=" + cost
				+ ", makeTypeId=" + makeTypeId + ", length=" + length
				+ ", width=" + width + ", squareNum=" + squareNum + ", proId="
				+ proId + ", proName=" + proName + ", specification="
				+ specification + ", finishedContent=" + finishedContent
				+ ", unit=" + unit + ", priceType=" + priceType + ", wcId="
				+ wcId + ", isCoop=" + isCoop + ", lengType=" + lengType
				+ ", isSetu=" + isSetu + "]";
	}
