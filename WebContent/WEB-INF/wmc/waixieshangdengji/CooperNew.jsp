...
<html>
	...
	<body onload="doInit();" class="sheet modal-dialog" style="min-width: 1000px;">
		<div class="sheet-main" id="bodyDiv">
			<form class="layui-form" name="frm" method="post" action="waixieshang_AddCooperNew">
									...
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="15" onkeyup="goNextInput(establishment.estName);" id="establishment.estCode" name="establishment.estCode" disabled="" value="${establishment.estCode}">
												</div>
												<script language="javascript">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline" style="width: 130px;">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(establishment.phone);" id="establishment.estName" name="establishment.estName" value="${establishment.estName}">
													<script language="javascript">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline" style="width: 130px;">
													<input class="layui-input" readonly placeholder="" type="text" id="establishment.managerName" name="establishment.managerName" value="  ${establishment.managerName}">
													<input type="hidden" id="establishment.managerId" name="establishment.managerId" value="${establishment.managerName}">
													<script language="javascript">
														setFormErrorMsg('', 3);
													</script>
												</div>
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<input type="hidden" name="establishment.status" id="establishment.status" value="${establishment.status}" >
												</div>
											</div>
										</div>
									</div>
							...
							<fieldset class="layui-elem-field layui-field-title">
								...
								<div class="layui-field-box">
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="20" onkeyup="goNextInput(&#39;establishment.fax&#39;);" id="establishment.phone" name="establishment.phone" value="${establishment.phone}">
												</div>
												<script language="javascript">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="20" onkeyup="goNextInput(&#39;establishment.email&#39;);" id="establishment.fax" name="establishment.fax" value="${establishment.fax}">
												</div>
												<script language="javascript">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.webSite&#39;);" id="establishment.email" name="establishment.email" value="${establishment.email}">
												</div>
												<script language="javascript">
									...
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.postcode&#39;);" id="establishment.webSite" name="establishment.webSite" value="${establishment.webSite}">
												</div>
												<script language="javascript">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="10" onkeyup="goNextInput(&#39;establishment.address&#39;);" id="establishment.postcode" name="establishment.postcode" value="${establishment.postcode}">
												</div>
												<script language="javascript">
									...
									<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.mark&#39;);" style="width:390px" id="establishment.address" name="establishment.address" value="${establishment.address}">
												</div>
												<script language="javascript">
							...
							<fieldset class="layui-elem-field layui-field-title">
								...
								<div class="layui-field-box">
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label">开户银行1：</label>
												<div class="layui-input-inline">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label" style="padding-left: 0; width: 85px;">银行账号1：</label>
												<div class="layui-input-inline">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label">开户名1：</label>
												<div class="layui-input-inline">
									...
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label">开户银行2：</label>
												<div class="layui-input-inline">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label">银行帐号2：</label>
												<div class="layui-input-inline">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label">开户名2：</label>
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.invoBankCode&#39;);" id="establishment.invoBankCode" name="establishment.invoBankCode" value="">
												</div>
												<script language="javascript">
