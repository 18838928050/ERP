...
<h1 align="center">安装单反审核查看</h1>
	...
	<tr>
	<td><s:a href="anzhuagndanfanshenhe_notexamined2?anAzhuangdanchakanBean.a=%{a}">反审核</s:a></td>
	<td>	<s:a href="anzhuagndanfanshenhe_tuichu">退出</s:a></td>
	</tr>
