...
<script language="javascript">
	function doShow(id){
		var url="../business/SetuBillEdit.html?id="+id;
		ShowIframe("安装单",url,1024,500,"refreshWin()",1024,600);
	}
	function refreshWin(){
		if(popRetVal!=null){
	...
	function createPageParaStr(){
		var str="bill_start="+encodeURIComponent(document.getElementById("bill_start").value);
		str=str+"&bill_end="+encodeURIComponent(document.getElementById("bill_end").value);
		str=str+"&plan_start="+encodeURIComponent(document.getElementById("plan_start").value);
		str=str+"&plan_end="+encodeURIComponent(document.getElementById("plan_end").value);
		str=str+"&real_start="+encodeURIComponent(document.getElementById("real_start").value);
		str=str+"&real_end="+encodeURIComponent(document.getElementById("real_end").value);
		...
		str=str+"&setu_name="+encodeURIComponent(document.getElementById("setu_name").value);
	...
	function createProgramParaStr(){
		var str="bill_start="+encodeURIComponent(document.getElementById("hid_bill_start").value);
		str=str+"&bill_end="+encodeURIComponent(document.getElementById("hid_bill_end").value);
		str=str+"&plan_start="+encodeURIComponent(document.getElementById("hid_plan_start").value);
		str=str+"&plan_end="+encodeURIComponent(document.getElementById("hid_plan_end").value);
		str=str+"&real_start="+encodeURIComponent(document.getElementById("hid_real_start").value);
		str=str+"&real_end="+encodeURIComponent(document.getElementById("hid_real_end").value);
		str=str+"&exam=";
		str=str+"&comp=";
		...
		str=str+"&setu_name="+encodeURIComponent(document.getElementById("hid_setu_name").value);
		str=str+"&ts_id=1";
		str=str+"&order_by=";
		str=str+"&order_sc=";
	...
	function doSearch(){
		...
		if(IsAdvSearch){//高级
			...
			if(document.getElementById("cb_bill_date").checked){
				if(!checkDateStr(document.getElementById("bill_start").value,"派单开始日期")){
					return;
				}
				if(!checkDateStr(document.getElementById("bill_end").value,"派单结束日期")){
					return;
				}
				str=str+"&cb_bill_date=1";
			}
			if(document.getElementById("cb_plan_date").checked){
				if(!checkDateStr(document.getElementById("plan_start").value,"计划完工开始日期")){
					return;
				}
				if(!checkDateStr(document.getElementById("plan_end").value,"计划完工结束日期")){
					return;
				}
				str=str+"&cb_plan_date=1";
			}
			if(document.getElementById("cb_real_date").checked){
				if(!checkDateStr(document.getElementById("real_start").value,"实际完工开始日期")){
					return;
				}
				if(!checkDateStr(document.getElementById("real_end").value,"实际完工结束日期")){
					return;
				}
				str=str+"&cb_real_date=1";
			}
			...
			if(document.getElementById("cb_lm").checked){
				...
				if(lm==null || lm==""){
					ShowAlert('提示框','请输入联系人姓名',200,100);
					return;
				}
				str=str+"&cb_lm=1";
			}
			...
			if(document.getElementById("cb_mng").checked){
				...
				if(mngName==null || mngName==""){
					ShowAlert('提示框','请输入负责人姓名',200,100);
					return;
				}
				str=str+"&cb_mng=1";
			}
			if(document.getElementById("cb_setu").checked){
				var setuName=document.getElementById("setu_name").value.trim();
				if(setuName==null || setuName==""){
					ShowAlert('提示框','请输入安装人员姓名',200,100);
					return;
				}
				str=str+"&cb_setu=1";
			}
		...
		window.location="../business/SetuBillSearchResult.html?"+str;
	}
	...
	function doDownload(){
		var str=getSearchCondition();
		window.location="../business/SetuBillSearchResult.html?content_type=EXCEL&"+str;
	}
	function doCancel(){
		window.close();
	}
	...
	function doPrint(id){
		showWin(900,600,"../business/SetuBillPrint.html?id="+id);
	}
	...
	function setDate(type,objType){
		...
		if(objType=="BILL"){
			document.getElementById("bill_start").value=startStr;
			document.getElementById("bill_end").value=endStr;
			doAutoCheck("cb_bill_date");
		}else if(objType=="PLAN"){
			document.getElementById("plan_start").value=startStr;
			document.getElementById("plan_end").value=endStr;
			doAutoCheck("cb_plan_date");
		}else if(objType=="REAL"){
			document.getElementById("real_start").value=startStr;
			document.getElementById("real_end").value=endStr;
			doAutoCheck("cb_real_date");
		}
	}
	function showExaPage(id){
		var url="../business/SetuBillInfoForExam.html?id="+id;
		ShowIframe("审核",url,900,500,"refreshWin()");
	}
	function showUnExaPage(id){
		var url="../business/SetuBillInfoForUnExam.html?id="+id;
		ShowIframe("反审核",url,900,500,"refreshWin()");
	}
	function showCompPage(id){
		var url="../business/SetuBillComp.html?id="+id;
		ShowIframe("完工",url,500,500,"refreshWin()");
	}
	function showUnCompPage(id){
		ShowConfirm('确认框','确定反完工吗？',340,80,"doUnCompCallBack('"+id+"')");
	}
	function doUnCompCallBack(id){
		if(popRetVal!=null){
			var url="../business/SetuBillUnComp.html?id_str="+id;
			ShowIframe("安装单反完工",url,200,200,"refreshWin()");
		}
	}
					...
					<table class="MoreOption" cellpadding="0" cellspacing="0">
						<tbody><tr>
			    			...
			    			<th class="c2" width="80px">
			    				<input type="checkbox" name="cb_plan_date" id="cb_plan_date">
			        			计划完工
			        		</th>
			    			<td width="280px">
			        			<input type="text" class="TextBox Datetime" maxlength="15" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_plan_date&#39;);" id="plan_start" name="plan_start" value="">
				            	<img src="${pageContext.request.contextPath }/images/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;plan_start&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_plan_date\&#39;)&#39;);">
				            	<input type="hidden" id="hid_plan_start" value="">
				            	至
				            	<input type="text" class="TextBox Datetime" maxlength="15" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_plan_date&#39;);" id="plan_end" name="plan_end" value="">
				            	<img src="${pageContext.request.contextPath }/images/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;plan_end&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_plan_date\&#39;)&#39;);">
				            	<input type="hidden" id="hid_plan_end" value="">
			    			</td>
			    		</tr>
			    		<tr>
			    			<th class="c1">
			    			...
			    			<th class="c2">
			    				<input type="checkbox" name="cb_real_date" id="cb_real_date">
			        			实际完工
			        		</th>
			    			<td>
			    				<input type="text" class="TextBox Datetime" maxlength="15" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_real_date&#39;);" id="real_start" name="real_start" value="">
				            	<img src="${pageContext.request.contextPath }/images/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;real_start&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_real_date\&#39;)&#39;);">
				            	<input type="hidden" id="hid_real_start" value="">
				            	至
				            	<input type="text" class="TextBox Datetime" maxlength="15" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_real_date&#39;);" id="real_end" name="real_end" value="">
				            	<img src="${pageContext.request.contextPath }/images/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;real_end&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_real_date\&#39;)&#39;);">
				            	<input type="hidden" id="hid_real_end" value="">
			    			</td>
						</tr>
						<tr>
							<th class="c1">
								<input type="checkbox" name="cb_lm" id="cb_lm">
			        			联系人
			        		</th>
			        		<td class="c1">
			        			<input type="text" class="TextBox" maxlength="50" name="lm" id="lm" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_lm&#39;);" value="">
								<input type="hidden" id="hid_lm" value="">
			    			</td>
			    			<th class="c2">
			    		...
			    		<tr>
			    			<th class="c1">
			        			<input type="checkbox" name="cb_phon" id="cb_phon">
			        			电话
			        		</th>
			        		<td class="c1">
			        			<input type="text" class="TextBox" maxlength="50" name="phon" id="phon" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_phon&#39;);" value="">
								<input type="hidden" id="hid_phon" value="">
			    			</td>
			    			<th class="c2">
			    			...
			    			<td class="c3">
			    				<input type="radio" name="comp" id="comp1" onclick="doAutoCheck(&#39;cb_comp&#39;);" checked="true">已完工
								<input type="radio" name="comp" id="comp2" onclick="doAutoCheck(&#39;cb_comp&#39;);">未完工
								<input type="radio" name="comp" id="comp3" onclick="doAutoCheck(&#39;cb_comp&#39;);">全部
			    			</td>
						</tr>
						<tr>
							<th class="c1">
			        		...
			        		<th class="c2">
			        			<input type="checkbox" name="cb_setu" id="cb_setu">
			        			安装人员
			        		</th>
			        		<td class="c3">
			        			<input type="text" class="TextBox" maxlength="15" name="setu_name" id="setu_name" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_setu&#39;);" value="">
								<img class="imgIconButton" src="${pageContext.request.contextPath }/images/make-a.gif" onclick="selectStafferName(&#39;setu_name&#39;,&#39;cb_setu&#39;);">
								<input type="hidden" id="hid_setu_name" value="">
			    			</td>
						</tr>
						<tr>
							<th class="c1">
			        		...
			        		<td class="c3">
			        			...
			        			<img class="imgIconButton" src="${pageContext.request.contextPath }/images/make-a.gif" onclick="selectStafferName(&#39;mng_name&#39;,&#39;cb_mng&#39;);">
						...
						<tr>
			        		...
			        		<th class="c2">
			        			<input type="checkbox" name="cb_creater" id="cb_crea">
			        			开单人
			        		</th>
			        		<td class="c3">
	  	...
	  	<div class="msg-error" id="errorMsgTd">
			...
			<div class="table-list">
		  		<table width="100%">      
					<tbody><tr>	
						<th width="12%">安装单号
						</th><th width="8%">派单日期</th>
						<th width="10%">订货单位</th>
						<th width="12%">业务单号
						</th><th width="8%">金额
						</th><th width="11%">计划/实际完工</th>
						<th width="10%">安装地址</th>
						<th width="7%">安装人员</th>
						<th width="6%">负责人</th>
						<th width="6%">开单人</th>
...
<td>${k }</td>
<td>
<s:if test='l==("Y")'><s:a action="anzhuangdanyilanbiaoo_chakan?anAzhuangdanchakanBean.a=%{a}">已审核</s:a></s:if>
<s:elseif test='l==("N")'><s:a action="anzhuangdanyilanbiaoo_chakan2?anAzhuangdanchakanBean.a=%{a}">未审核</s:a></s:elseif>
<s:if test='m==("Y")'><s:a action="anzhuangdanyilanbiaoo_fanwanggongg?fBean.a=%{a}">已完工</s:a></s:if>
<s:elseif test='m==("N")'><s:a action="anzhuangdanyilanbiaoo_wangong?fBean.a=%{a}">未完工</s:a></s:elseif>
</td>
<td><s:a href="anzhuangdanyilanbiaoo_wangongbiaochakan?fBean.a=%{a}">查看</s:a></td>
...
<script type="text/javascript">
	...
	(function(){
	    ...
	    lnkMoreOption.onclick = function(){
	        ...
	        document.getElementById('cb_bill_date').style.visibility = 'visible';
	        this.style.visibility = 'hidden';
	    };
	    lnkHiddenOption.onclick = function(){
	    	IsAdvSearch = false;
	        document.getElementById('dvMoreOptionBox').style.display = 'none';
	        document.getElementById('cb_bill_date').style.visibility = 'hidden';
