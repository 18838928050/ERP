...
<td>${mark}</td>
<td>${managerName }</td>
<td><s:a action="songhuoduizhang_duizhang?establishmentVO.estCode=%{estCode}">选择</s:a></td>
</tr>
	...
	<form action="songhuoduizhang_findAll" method="post">
	
	<a href="${pageContext.request.contextPath}/songhuoduizhang_findAll?CurrentPageNum=${fenyeMode.currentPageNum-1}">上一页</a>
...
<a href="${pageContext.request.contextPath}/songhuoduizhang_findAll?CurrentPageNum=${fenyeMode.currentPageNum+1}">下一页</a>
