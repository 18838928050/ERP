...
<h1 align="center">安装单审核查看</h1>
	...
	<tr>
	<td><s:a href="anzhuagndanshenhe_examined2?anAzhuangdanchakanBean.a=%{a}">审核通过</s:a></td>
	<td>	<s:a href="anzhuagndanshenhe_tuichu">退出</s:a></td>
	</tr>
