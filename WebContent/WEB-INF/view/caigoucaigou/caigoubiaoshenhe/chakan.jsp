...
<hr color="red">
${purchaseBillExtVO } --%>
<h1 align="center">采购单(biao)审核</h1>
...
<hr>
<s:a action="caigoubiaoshenhe_shenhetongguo?purchaseBillVO.id=%{purchaseBillVO.id}">审核通过</s:a>
<s:a action="caigoubiaoshenhe_tuichu">退出</s:a>
</body>
</html>