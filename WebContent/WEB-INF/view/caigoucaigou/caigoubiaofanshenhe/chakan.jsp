...
<hr color="red">
${purchaseBillExtVO } --%>
<h1 align="center">采购单反(biao)审核</h1>
...
<hr>
<s:a action="caigoubiaofanshenhe_shenhebutongguo?purchaseBillVO.id=%{purchaseBillVO.id}">反审核</s:a>
<s:a action="caigoubiaofanshenhe_tuichu">退出</s:a>
</body>
</html>