...
<hr color="red">
${purchaseBillExtVO } --%>
<h1 align="center">退货单反(biao)审核</h1>
...
<hr>
<s:a action="tuihuobiaofanshenhe_shenhebutongguo?purchaseBillVO.id=%{purchaseBillVO.id}">反审核</s:a>
<s:a action="tuihuobiaofanshenhe_tuichu">退出</s:a>
</body>
</html>