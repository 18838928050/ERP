...
<hr color="red">
${purchaseBillExtVO } --%>
<h1 align="center">退货单(biao)审核</h1>
...
<hr>
<s:a action="tuihuobiaoshenhe_shenhetongguo?purchaseBillVO.id=%{purchaseBillVO.id}">审核通过</s:a>
<s:a action="tuihuobiaoshenhe_tuichu">退出</s:a>
</body>
</html>