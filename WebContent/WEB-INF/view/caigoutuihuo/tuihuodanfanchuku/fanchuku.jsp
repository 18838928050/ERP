...
<hr>
<s:a action="tuihuodanfanchuku_tuihuodanfanchuku?purchaseBillVO.id=%{purchaseBillVO.id}">取消出库</s:a>
<s:a action="tuihuodanfanchuku_tuichu">退出</s:a>
</body>
</html>