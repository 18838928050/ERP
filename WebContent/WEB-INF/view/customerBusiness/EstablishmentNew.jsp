...
<script language="javascript">
	...
	function doContactAdd(){
		...
		input.setAttribute("name","establishmentContact["+contactNum+"].contactName");
	...
	function doCheck(){
		var checkKey=document.getElementById("establishment.estName").value.trim();
		if(checkKey!=""){
			var url="customer_establishmentCheck?establishment.estName="+checkKey;
	...
	function selectSuperior(){
		var url="../base/EstablishmentListForSelect.html?type=CLIENT&show_all=Y";
...
<form name="frm" method="post" action="customer_addCustomer"> 
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
	    			...
	    			<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a2">
							<tbody><tr>
						      	...
						      	<td>
							    <input type="text" maxlength="15" onkeyup="goNextInput(establishment.estName);" id="establishment.estCode" name="establishment.estCode" value="" disabled="" class="TextBox readonly">
						          <script language="javascript">
						     	...
						     	<td>
						     		<input type="text" class="TextBox" maxlength="50" onkeyup="goNextInput(establishment.phone);" id="establishment.estName" name="establishment.estName" value="">
									<img class="make-a" src="images/make-c.gif" style="cursor:pointer;" onclick="doCheck('1');" title="查出哪些客户是重名的，已删除的重名客户可以在这里恢复">
							          <script language="javascript">
								...
								<th>经办人：</th>
						     	<td>
									<input class="TextBox readonly" readonly="true" type="text" id="establishment.managerName" name="establishment.managerName" value="管理员">
						    ...
						    <tr>
								...
								<input class="TextBox" type="text" id="establishment.creditCost" name="establishment.creditCost" value="0">
						    ...
						    <tr>
						      	...
						      	<td>
						    		...
						    		<input type="text" class="TextBox readonly" readonly="true" id="superiorName" name="superiorName" value="" title="设定客户的上级单位或总部，方便业务查询统计">
								...
								<th>状态：</th>
						     	<td>
						     		<input type="radio" name="r_status" id="r_status1" onclick="changeStatus();" checked="">正常
									<input type="radio" name="r_status" id="r_status2" onclick="changeStatus();">停用
				  ...
				  <fieldset class="det_fieldset "> <legend class="mag10">辅助信息</legend>
	    			<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a2">
								<tbody><tr>
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="20" onkeyup="goNextInput(&#39;establishment.fax&#39;);" id="establishment.phone" name="establishment.phone" value="">
								          <script language="javascript">
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="20" onkeyup="goNextInput(&#39;establishment.email&#39;);" id="establishment.fax" name="establishment.fax" value="">
								          <script language="javascript">
								          	setFormErrorMsg('',8,'establishment.fax');
								          </script>
							     	</td>
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="50" onkeyup="goNextInput(&#39;establishment.webSite&#39;);" id="establishment.email" name="establishment.email" value="">
								          <script language="javascript">
								          	setFormErrorMsg('',9,'establishment.email');
								          </script>
							     	</td>
							    ...
							    <tr>
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="50" onkeyup="goNextInput(&#39;establishment.postcode&#39;);" id="establishment.webSite" name="establishment.webSite" value="">
								          <script language="javascript">
...
<option value="480">&nbsp;&nbsp;|--古城区</option>
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="10" onkeyup="goNextInput(&#39;establishment.address&#39;);" id="establishment.postcode" name="establishment.postcode" value="">
								          <script language="javascript">
							    ...
							    <tr>
							     	...
							     	<td colspan="5">
							     		<input type="text" class="TextBox" maxlength="50" onkeyup="goNextInput(&#39;establishment.mark&#39;);" style="width:390px" id="establishment.address" name="establishment.address" value="">
								          <script language="javascript">
					  ...
					  <div class="table-list" style="padding:10px">
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" id="contactTbl">
								...
								<tr id="contactTr0">
									...
									<td>
										<select id="sex_0" name="sex_0" onchange="checkContactChange(0);">
										   <option value="男">男</option>
										   <option value="女">女</option>
										</select>
									</td>
									<td>
										<input type="text" style="width:48px" class="TextBox" maxlength="15" id="possie_0" name="possie_0" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:82px" class="TextBox" maxlength="15" id="mobile_0" name="mobile_0" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:114px" class="TextBox" maxlength="50" id="email_0" name="email_0" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="18" id="phone_0" name="phone_0" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="25" id="im_0" name="im_0" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="100" id="mark_0" name="mark_0" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="checkbox" id="is_main_0" name="is_main_0" value="1" onchange="checkContactChange(0);">
									</td>
									<td>
								...
								<tr id="contactTr1">
									...
									<td>
										<select id="sex_1" name="sex_1" onchange="checkContactChange(1);">
										   <option value="男">男</option>
										   <option value="女">女</option>
										</select>
									</td>
									<td>
										<input type="text" style="width:48px" class="TextBox" maxlength="15" id="possie_1" name="possie_1" value="" onchange="checkContactChange(1);">
									</td>
									<td>
										<input type="text" style="width:82px" class="TextBox" maxlength="15" id="mobile_1" name="mobile_1" value="" onchange="checkContactChange(1);">
									</td>
									<td>
										<input type="text" style="width:114px" class="TextBox" maxlength="50" id="email_1" name="email_1" value="" onchange="checkContactChange(1);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="18" id="phone_1" name="phone_1" value="" onchange="checkContactChange(1);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="25" id="im_1" name="im_1" value="" onchange="checkContactChange(1);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="100" id="mark_1" name="mark_1" value="" onchange="checkContactChange(1);">
									</td>
									<td>
										<input type="checkbox" id="is_main_1" name="is_main_1" value="1" onchange="checkContactChange(1);">
									</td>
									<td>
								...
								<tr id="contactTr2">
									...
									<td>
										<input type="text" style="width:48px" class="TextBox" maxlength="15" id="possie_2" name="possie_2" value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:82px" class="TextBox" maxlength="15" id="mobile_2" name="mobile_2" value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:114px" class="TextBox" maxlength="50" id="email_2" name="email_2" value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="18" id="phone_2" name="phone_2" value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="25" id="im_2" name="im_2" value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="100" id="mark_2" name="mark_2" value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="checkbox" id="is_main_2" name="is_main_2" value="1" onchange="checkContactChange(2);">
									</td>
									<td>
				  ...
				  <div class="blank12"></div>
				  <fieldset class="det_fieldset ">
				  	<legend class="mag10">开票资料</legend>
					<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a2">
						<tbody><tr>
					      	<th>开票名称：</th>
					     	
					     	<td>
					     		<input type="text" class="TextBox" style="width:160px" maxlength="50" onkeyup="goNextInput(&#39;establishment.invoCode&#39;);" id="establishment.invoName" name="establishment.invoName" value="">
						          <script language="javascript">
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:180px" maxlength="25" onkeyup="goNextInput(&#39;establishment.invoAddr&#39;);" id="establishment.invoCode" name="establishment.invoCode" value="">
						          <script language="javascript">
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:160px" maxlength="100" onkeyup="goNextInput(&#39;establishment.invoBankName&#39;);" id="establishment.invoAddr" name="establishment.invoAddr" value="">
						          <script language="javascript">
						...
						<tr>
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:160px" maxlength="50" onkeyup="goNextInput(&#39;establishment.invoBankCode&#39;);" id="establishment.invoBankName" name="establishment.invoBankName" value="">
						          <script language="javascript">
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:180px" maxlength="50" onkeyup="goNextInput(&#39;establishment.invoBankCode&#39;);" id="establishment.invoBankCode" name="establishment.invoBankCode" value="">
						          <script language="javascript">
						          	setFormErrorMsg('',19);
						          </script>
					     	</td>
				  	...
				  	<legend class="mag10">单据打印</legend>
						<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a2">
							<tbody><tr>
						      	<th>业务单打印：</th>
						     	<td>
						     		<input type="radio" name="r_busi_pphone" id="r_busi_pphone1" onclick="changeBusiPphone();" checked="">显示（联系人、电话、地址）
									<br>
									<input type="radio" name="r_busi_pphone" id="r_busi_pphone2" onclick="changeBusiPphone();">隐藏（联系人、电话、地址）
						      	...
						      	<th>送货单打印：</th>
						     	<td>
						     		<input type="radio" name="r_deli_pphone" id="r_deli_pphone1" onclick="changeDeliPphone();" checked="">显示（联系人、电话、地址）
									<br>
									<input type="radio" name="r_deli_pphone" id="r_deli_pphone2" onclick="changeDeliPphone();">隐藏（联系人、电话、地址）
						     	...
						     	<th>制作单打印：</th>
						     	<td>
						     		<input type="radio" name="r_make_pphone" id="r_make_pphone1" onclick="changeMakePphone();">显示（联系人、电话、地址）
									<br>
									<input type="radio" name="r_make_pphone" id="r_make_pphone2" onclick="changeMakePphone();" checked="">隐藏（联系人、电话、地址）
				  	...
				  	<div style="padding:10px;">
							<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
								<tbody><tr>
									...
									<td>
										<textarea class="TextBox" style="width:660px;height:80px" id="establishment.mark" name="establishment.mark"></textarea>
								          <script language="javascript">
