...
<script language="javascript">
	function doShow(id){
		...
		ShowIframe("出库单审核",url,900,500,"refreshWin()",900,600);
	}
	function refreshWin(){
		if(popRetVal!=null){
	...
	function doExamineCallBack(id){
		if(popRetVal!=null){
			var url="/storehouse/OutBillExamine.ihtm?id_str="+id+"&flag=1";
	...
	function doSearch(){
		...
		window.location="outStoreExamine_toOutStoreExamine?ts_id="+tsId+"&search_key="+searchKey;
	}
	function doGo(pageIndex){
		var searchKey=encodeURIComponent("");
		window.location="outStoreExamine_toOutStoreExamine?ts_id=1&search_key="+searchKey+"&current_page="+pageIndex;
	}
