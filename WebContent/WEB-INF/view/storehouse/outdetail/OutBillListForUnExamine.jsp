...
<!-- saved from url=(0064)http://115.28.87.22:8888/storehouse/OutBillListForUnExamine.ihtm -->
...
<script language="javascript">
	function doShow(id){
		...
		ShowIframe("出库单反审核",url,900,500,"refreshWin()",900,600);
	}
	function refreshWin(){
		if(popRetVal!=null){
	...
	function doExamineCallBack(id){
		if(popRetVal!=null){
			var url="/storehouse/OutBillExamine.ihtm?id_str="+id+"&flag=0";
	...
	function doSearch(){
		...
		window.location="outStoreUnExamine_toOutStoreUnExamine?ts_id="+tsId+"&search_key="+searchKey;
	}
	function doGo(pageIndex){
		var searchKey=encodeURIComponent("");
		window.location="outStoreUnExamine_toOutStoreUnExamine?ts_id=1&search_key="+searchKey+"&current_page="+pageIndex;
	}
