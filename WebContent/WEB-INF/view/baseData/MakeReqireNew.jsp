...
<!-- saved from url=(0049)http://115.28.87.22:8888/base/MakeRequireNew.ihtm -->
...
<div class="sheet-main" id="bodyDiv" style="width:475px;">
	<form action="MakeRequire_makeRequireNew" method="post">
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
							<input type="text" maxlength="50" class="TextBox" onkeyup="goNextInput(&#39;requireContent&#39;);" id="code" name="code" value="">
					          <script language="javascript">
					...
					<tr>
				      	...
				      	<td>
				      		<textarea style="width:280px;height:50px" id="requireContent" name="requireContent"></textarea>
							  <script language="javascript">
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" id="price" onkeyup="goNextInput(&#39;sequenceCode&#39;);" name="price" value="0">
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="">
