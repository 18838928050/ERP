...
<!-- saved from url=(0056)http://115.28.87.22:8888/base/EstablishmentLevelNew.ihtm -->
...
<div class="sheet-main" id="bodyDiv" style="width:295px;">
	<form action="customerLevel_CustomerLevelNew" method="post">
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;sequenceCode&#39;);" id="levelName" name="levelName" >
					          <script language="javascript">
