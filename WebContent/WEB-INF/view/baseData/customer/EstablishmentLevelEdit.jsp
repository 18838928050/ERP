...
<!-- saved from url=(0062)http://115.28.87.22:8888/base/EstablishmentLevelEdit.ihtm?id=1 -->
...
<div class="sheet-main" id="bodyDiv" style="width:295px;">
	<form action="customerLevel_updateCustomerLevelEdit" method="post">
	
	<input  name="id" value="${customLevels.id }" hidden />
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;sequenceCode&#39;);" id="levelName" name="levelName" value="${customLevels.levelName }">
					          <script language="javascript">
					          	setFormErrorMsg('',1,'levelName');
					          </script>
				     	</td>
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="${customLevels.sequenceCode }">
