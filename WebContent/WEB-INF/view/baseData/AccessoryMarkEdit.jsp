...
<!-- saved from url=(0057)http://115.28.87.22:8888/base/AccessoryMarkEdit.ihtm?id=1 -->
...
<div class="sheet-main" id="bodyDiv" style="width:475px;">
	<form action="AccessoryMark_updateAccessoryMark" method="post">
	<input name="id" value="${accessoryMark.id }" hidden/>
	  ...
	  <td colspan="2">
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	<th><span class="MustInput">*</span>文件说明：</th> 
				      	
				      	<td>
				      		<input type="text" class="TextBox" style="width:260px" maxlength="50" onkeyup="goNextInput(&#39;sequenceCode&#39;);" id="mark" name="mark" value="${accessoryMark.mark }">
							  <script language="javascript">
								setFormErrorMsg('',1,'requireContent');
					      	  </script>
				     	</td>
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="${accessoryMark.sequenceCode }">
