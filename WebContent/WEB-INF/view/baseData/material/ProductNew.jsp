...
<!-- saved from url=(0056)http://115.28.87.22:8888/base/ProductNew.html?type_id=72 -->
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a2">
					<tbody><tr>
				      	...
				      	<td>
							...
							<input type="text" maxlength="15" onkeyup="goNextInput(&#39;product.productName&#39;);" id="product.productCode" name="product.productCode" value="" disabled="" class="TextBox readonly">
					          <script language="javascript">
				     	...
				     	<td style="width:20%">
				     		<input type="text" class="TextBox" maxlength="100" onkeyup="goNextInput(&#39;product.unit&#39;);" id="product.productName" name="product.productName" value="">
					          <script language="javascript">
				    	...
				    	<td>
							<input type="text" class="TextBox" maxlength="10" onkeyup="goNextInput(&#39;product.minLimit&#39;);" id="product.unit" name="product.unit" value="">
...
<option value="44">油漆类</option>
				    	...
				    	<th><span class="MustInput">*</span>最低库存：</th>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;product.maxLimit&#39;);" id="product.minLimit" name="product.minLimit" value="0">
				    	...
				    	<th><span class="MustInput">*</span>最高库存：</th>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;product.mark&#39;);" id="product.maxLimit" name="product.maxLimit" value="0">
