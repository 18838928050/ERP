...
<!-- saved from url=(0043)http://115.28.87.22:8888/base/UnitList.ihtm -->
...
<script language="javascript">
	...
	function doDelAct(id){
		if(popRetVal!=null){
			window.location="/base/UnitDelete.ihtm?id=d"+i;
		}
	}
	function doCancel(){
		window.close();
  ...
  <div class="sheet-list">
    <div class="search-business">
	    <div class="add_content"> 	
	    	 <div align="right"><input type="button" class="buttom search-add" value=" 新 增" onclick="doNew();"></div>
	     </div>
