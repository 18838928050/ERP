...
<!-- saved from url=(0048)http://115.28.87.22:8888/base/UnitEdit.ihtm?id=1 -->
...
<div class="sheet-main" id="bodyDiv" style="width:290px;">
	<form action="unit_toUnitEdit" method="post">
	
	
	<input  name="id" value="${unit.id }" hidden />
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
				      		...
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;sequenceCode&#39;);" id="unitName" name="unitName" value="${unit.unitName }">
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="${unit.sequenceCode }">
