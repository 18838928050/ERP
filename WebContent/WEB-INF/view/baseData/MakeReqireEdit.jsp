...
<!-- saved from url=(0055)http://115.28.87.22:8888/base/MakeRequireEdit.ihtm?id=1 -->
...
<script language="javascript">
	...
	function showMe(){
		showFormErrorMsg();
		document.getElementById("requireContent").focus();
	}
</script>
</head>
<body oncontextmenu="return false" onload="showMe();" class="sheet modal-dialog" style=" padding-top:15px;">
<div class="sheet-main" id="bodyDiv" style="width:475px;">
	<form action="MakeRequire_updateMakeReqireEdit" method="post">
	<input name="id" value="${makeRequire.id }" hidden/>
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
							<input type="text" maxlength="50" class="TextBox" onkeyup="goNextInput(&#39;requireContent&#39;);" id="code" name="code" value="${makeRequire.code }">
					          <script language="javascript">
					          	setFormErrorMsg('',1,'code');
					          </script>
				     	</td>
				     	
					</tr>
					<tr>
				      	<th><span class="MustInput">*</span>制作要求：</th> 
				      	
				      	<td>
				      		<textarea style="width:280px;height:50px" id="requireContent" name="requireContent">${makeRequire.requireContent }</textarea>
							  <script language="javascript">
								setFormErrorMsg('',2,'requireContent');
							  </script>
				     	</td>
				     	
					</tr>
					<tr>
			      		<th><span class="MustInput">*</span>附加单价：</th>
				      	
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" id="price" onkeyup="goNextInput(&#39;sequenceCode&#39;);" name="price" value="${makeRequire.price }">
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="${makeRequire.sequenceCode }">
