...
<!-- saved from url=(0058)http://115.28.87.22:8888/base/MakeTypeNew.ihtm?parent_id=0 -->
...
<div class="sheet-main" id="bodyDiv" style="width:325px;">
	<form action="MakeType_saveMakeTypeNew" method="post">
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;makeType.unit&#39;);" id="makeType.typeName" name="typeName" value="">
							  <script language="javascript">
								setFormErrorMsg('',1);
							  </script>
				     	</td>
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;lossRateStr&#39;);" id="makeType.unit" name="unit" value="">
							  <script language="javascript">
								setFormErrorMsg('',1);
							  </script>
				     	</td>
...
<%-- 					<tr>
				      	...
				      	<td>
							<select id="makeType.parentId" name="makeType.parentId" style="width:140px">
...
<option value="159">&nbsp;|--礼品</option>
					...
					<tr>
				      	<th>自动扣库存：</th>
				      	<td>
				      		<input type="radio" name="r_autoStoc" id="r_autoStoc2" onclick="changeAutoStoc(&#39;Y&#39;);">是
				      		<input type="radio" name="r_autoStoc" id="r_autoStoc1" onclick="changeAutoStoc(&#39;N&#39;);" checked="">否
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="5" onkeyup="goNextInput(&#39;makeType.sequCode&#39;);" id="lossRateStr" name="lossRate" value="0">
					        <script language="javascript">
					          	setFormErrorMsg('',5);
					        </script>
				     	</td>
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="20" onkeyup="goNextInput(&#39;&#39;);" id="makeType.sequCode" name="sequCode" value="16">
							<script language="javascript">
								setFormErrorMsg('',6);
							</script>
				     	</td>
