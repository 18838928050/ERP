...
<!-- saved from url=(0059)http://115.28.87.22:8888/base/DepartmentNew.ihtm?parent_id= -->
...
<script language="javascript">
	...
	function showMe(){
		showFormErrorMsg();
		document.getElementById("department.departmentName").focus();
	}
</script>
</head>
<body oncontextmenu="return false" scroll="no" onload="showMe();" class="sheet modal-dialog" style=" padding-top:15px;">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
							...
							<input type="text" maxlength="15" onkeyup="goNextInput(&#39;department.departmentName&#39;);" id="department.departmentCode" name="department.departmentCode" value="" disabled="" class="TextBox readonly">
					          <script language="javascript">
					          	setFormErrorMsg('',1,'department.departmentCode');
					          </script>
				     	</td>
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;department.parentId&#39;);" id="department.departmentName" name="department.departmentName" value="">
					          <script language="javascript">
					          	setFormErrorMsg('',2,'department.departmentName');
					          </script>
				     	</td>
					...
					<tr>
				      	...
				      	<td>
				      		<select id="department.parentId" name="department.parentId">
