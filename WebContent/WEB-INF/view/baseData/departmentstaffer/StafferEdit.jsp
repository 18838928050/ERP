...
<!-- saved from url=(0052)http://115.28.87.22:8888/base/StafferEdit.html?id=61 -->
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a2">
					<tbody><tr>
				      	...
				      	<td>
							...
							<input type="text" maxlength="15" onkeyup="goNextInput(&#39;staffer.stafferName&#39;);" id="staffer.stafferCode" name="staffer.stafferCode" value="B0055" class="TextBox">
					          <script language="javascript">
				     	...
				     	<td>
				     		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;birthdayStr&#39;);" id="staffer.stafferName" name="staffer.stafferName" value="何盼盼">
					          <script language="javascript">
				      	...
				      	<td>
				      		<input type="radio" name="sexRadio" onclick="changeSex();">男
							<input type="radio" name="sexRadio" onclick="changeSex();" checked="">女
							
								<input type="hidden" id="staffer.sex" name="staffer.sex" value="FEMALE">
						          <script language="javascript">
						          	setFormErrorMsg('',3);
						          </script>
...
<option value="33" selected="">财务部</option>
				  			</select>
					        <script language="javascript">
					          	setFormErrorMsg('',13);
					        </script>
					...
					<tr>
				    	...
				    	<td>
				    		<input type="text" class="TextBox Datetime" maxlength="15" onkeyup="goNextInput(&#39;staffer.mark&#39;);" id="inDateStr" name="inDateStr" value="2017-07-03">
