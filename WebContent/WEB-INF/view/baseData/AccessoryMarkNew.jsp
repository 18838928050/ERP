...
<!-- saved from url=(0051)http://115.28.87.22:8888/base/AccessoryMarkNew.ihtm -->
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" style="width:260px" maxlength="50" onkeyup="goNextInput(&#39;sequenceCode&#39;);" id="mark" name="mark" value="">
							  <script language="javascript">
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="6">
