		...
		<s:iterator value="purchaseBillVOs" status="st">
			<tr>
				...
				<td>
					...
					<s:a action="tuikuancanleling_tuilistdetail?purchaseBillVO.id=%{id}">查看</s:a>
					<s:a action="tuikuancanleling_tuiguanlian?purchaseBillVO.id=%{id}&establishmentVO.id=%{establishmentVOs[#st.index].id}">关联数据</s:a>
				</td>
			</tr>
		</s:iterator>
	</table>
