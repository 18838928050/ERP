...
<!-- saved from url=(0051)http://115.28.87.22:8888/storehouse/InOutCount.ihtm -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta http-equiv="Pragma" content="no-cache">
<meta http-equiv="Cache-Control" content="no-cache">
<meta http-equiv="Expires" content="0">
<title>收发存汇总表 | 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
...
<script language="javascript">
	...
	function doPrint(){
		...
		showWin(1024,600,"/storehouse/InOutCount.ihtm?content_type=PRINT&"+str);
	}
	function doDownload(){
		var str=getSearchCondition();
		window.location="/storehouse/InOutCount.ihtm?content_type=EXCEL&"+str;
	}
	...
	function doSearch(){
		...
		if(IsAdvSearch){//高级
			...
			if(document.getElementById("cb_order_date").checked){
				...
				if(!checkDateStr(startDate,"开始日期")){
					return;
				}
				if(!checkDateStr(endDate,"结束日期")){
					return;
				}
				...
				if(sDate>eDate){
					ShowAlert('提示框','开始日期不能大于结束日期',200,100);
					return;
				}
		...
		window.location="/storehouse/InOutCount.ihtm?"+str;
	}
	...
	<div id="ListContainer" class="Container" style="width: 1808px;"><!-- 主体容器 -->
	    ...
	    <div class="Heading BillIcon">
	        <div class="HeadingContent">
	            <h1>收发存汇总表</h1>
	            <span class="Note">查询统计当期材料发生的收发存情况，以单据审核通过的日期作为记账日期</span>
	        </div>
	    </div>
...
<option value="44">油漆类</option>
			...
			<div id="contentDiv" style="background:#eafaff;">
			    ...
			    <div class="table-list">
			        <table width="100%">
			          <tbody><tr>
							<th width="10%" rowspan="2">材料类别</th>
							<th width="10%" rowspan="2">材料编号</th>
							<th width="15%" rowspan="2">品名规格</th>
							<th width="5%" rowspan="2">单位</th>
							<th width="15%" colspan="3" align="center">上期结存</th>
							<th width="15%" colspan="3" align="center">入库</th>
							<th width="15%" colspan="3" align="center">出库</th>
							<th width="15%" colspan="3" align="center">期末结存</th>
						</tr>
						<tr>
							<th width="5%">数量</th>
							<th width="5%">单价</th>
						...
						<s:iterator value="products">
							<tr class="query_list_data_tr1" index="1" style="cursor:pointer;" onmouseout="javascript:mouseout(this)" onmouseover="javascript:mouseover(this)">
							<td>${ pnSpell }</td>
							<td>${productName }</td>
							<td></td>
							<td>${unit }</td>
