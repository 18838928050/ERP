...
<script language="javascript">
	function doShow(id){
		...
		ShowIframe("收款单",url,1024,520,"refreshWin()",1024,600);
	}
	function refreshWin(){
		if(popRetVal!=null){
		...
		if(IsAdvSearch){//高级
			...
			if(document.getElementById("cb_bill_cont").checked){
				...
				if(billCont==null || billCont==""){
					ShowAlert('提示框','请输入收款单摘要',200,100);
					return;
				}
			...
			if(document.getElementById("cb_bb_cont").checked){
				...
				if(bbCont==null || bbCont==""){
					ShowAlert('提示框','请输入业务单摘要',200,100);
					return;
				}
	...
	function showExaPage(id){
		...
		ShowIframe("收款单审核",url,900,500,"refreshWin()");
	}
	function showUnExaPage(id){
		var url="finance/ReceiveBillInfoForUnExamine.html?id="+id;
		ShowIframe("收款单反审核",url,900,500,"refreshWin()");
	}
...
<div class="Wrap"><!-- 页面主框架 -->
	...
	<div id="ListContainer" class="Container" style="width: 980px;"><!-- 主体容器 -->
	    
	    <!-- 标题栏 -->
	    <div class="Heading BillIcon">
	        <div class="HeadingContent">
	            <h1>收款单一览表</h1>
	            <span class="Note">查询当期开出的收款单，但不包括业务单上填写的预付款，进入【统计报表-销售回款一览表】，才能查到当期全部的收款。</span>
	        </div>
	    </div>
	        ...
	        <div class="FilterBar ClearFix">
	            ...
	            <span class="fl">
	            	<table class="MoreOption" cellpadding="0" cellspacing="0">
	            		<tbody><tr><th class="c1" width="90px">
	            			<input type="checkbox" name="cb_receive_date" id="cb_receive_date" checked="true" style="visibility:hidden;">
	            			日期
	            		</th>
	            		<td width="360px">
	            			<input type="text" class="TextBox Datetime" maxlength="15" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_receive_date&#39;);" id="start_date" name="start_date" value="2017-07-01">
			            	<img src="images/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;start_date&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_receive_date\&#39;)&#39;);">
			            	<input type="hidden" id="hid_start_date" value="2017-07-01">
			            	至
			            	<input type="text" class="TextBox Datetime" maxlength="15" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_receive_date&#39;);" id="end_date" name="end_date" value="2017-07-09">
			            	<img src="images/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;end_date&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_receive_date\&#39;)&#39;);">
				...
				<div id="dvMoreOptionBox" class="MoreOptionBox" style="display:none;">
					<table class="MoreOption" cellpadding="0" cellspacing="0">
			    		...
			    		<tr>
							<th class="c1">
			        			<input type="checkbox" name="cb_bill_cont" id="cb_bill_cont">
			        			收款单摘要
			        		</th>
			        		<td class="c1">
...
<option value="33">财务部</option>
			    		...
			    		<tr>
			        		<th class="c1">
			        			<input type="checkbox" name="cb_bb_cont" id="cb_bb_cont">
			        			业务单摘要
			        		</th>
			    			<td class="c1">
