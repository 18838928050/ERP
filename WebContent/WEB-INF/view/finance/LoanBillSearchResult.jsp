...
<!-- saved from url=(0066)http://115.28.87.22:8888/finance/LoanBillSearchResult.html?type=IN -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta http-equiv="Pragma" content="no-cache">
<meta http-equiv="Cache-Control" content="no-cache">
<meta http-equiv="Expires" content="0">
<title>资金借入单一览表 | 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
...
<script language="javascript">
	function doShow(id){
		...
		ShowIframe("资金借入单",url,1024,420,"refreshWin()",1024,600);
	}
	function doNew(billId){
		var url="finance/LoanBillNew.html?type=BILL&bill_type=IN&bill_id="+billId;
		ShowIframe("资金借入单",url,1024,420,"refreshWin()",1024,600);
	}
	function refreshWin(){
		if(popRetVal!=null){
	...
	function doSearch(){
		...
		window.location="InDetail_toLoadBillResult?"+str;
	}
	...
	function getSearchCondition(){
		var searchType="1";
		var str="type=IN&search_type="+searchType;
		if(searchType=="1"){//高级
			str=str+"&cb_loan_date=1";
	...
	function showExaPage(id){
		...
		ShowIframe("资金借入单审核",url,900,300,"refreshWin()");
	}
	function showUnExaPage(id){
		var url="finance/LoanBillInfoForUnExamine.html?id="+id;
		ShowIframe("资金借入单反审核",url,900,300,"refreshWin()");
	}
</script>
</head>
	...
	<div id="ListContainer" class="Container" style="width: 988px;"><!-- 主体容器 -->
	    ...
	    <div class="Heading BillIcon">
	        <div class="HeadingContent">
	            <h1>资金借入单一览表</h1>
	            <span class="Note">查询当期发生的资金借入单</span>
	        </div>
	    </div>
