...
<!-- saved from url=(0068)http://115.28.87.22:8888/finance/LoanBillListForExamine.html?type=IN -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta http-equiv="Pragma" content="no-cache">
<meta http-equiv="Cache-Control" content="no-cache">
<meta http-equiv="Expires" content="0">
<title>资金借入单审核 | 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
...
<script language="javascript">
	function doShow(id){
		...
		ShowIframe("资金借入单审核",url,900,300,"refreshWin()",900,600);
	}
	function refreshWin(){
		if(popRetVal!=null){
	...
	function doExamineCallBack(id){
		if(popRetVal!=null){
			...
			ShowIframe("资金借入单审核",url,200,200,"refreshWin()");
		}
	}
	...
	function doSearch(){
		...
		window.location="inExamine_toInExamineResult?ts_id="+tsId+"&type="+type+"&search_key="+searchKey;
	}
	function doGo(pageIndex){
		var searchKey=encodeURIComponent("");
		var type="IN";
		window.location="inExamine_toInExamineResult?ts_id=1&type="+type+"&search_key="+searchKey+"&current_page="+pageIndex;
	}
