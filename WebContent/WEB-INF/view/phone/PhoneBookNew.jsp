...
<div class="sheet-main" id="bodyDiv" style="width:300px;">
	<form name="frm" method="post" action="phone_savePhoneBook">
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" style="width:54px" maxlength="15" onkeyup="goNextInput(&#39;mobile&#39;);" id="perName" name="phoneBook.perName" value="">
							  <script language="javascript">
					...
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" style="width:90px" maxlength="25" onkeyup="goNextInput(&#39;companyName&#39;);" id="mobile" name="phoneBook.mobile" value="">
							  <script language="javascript">
