...
<!-- saved from url=(0063)http://115.28.87.22:8888/finance/TransferBillListForCancel.html -->
	...
	<meta http-equiv="Pragma" content="no-cache">
		<meta http-equiv="Cache-Control" content="no-cache">
			<meta http-equiv="Expires" content="0">
				<title>转账取款作废 | 管理易-广告加工制作管理软件 企业版 9.28 | 易凯软件</title> <script
				...
				<link rel="stylesheet" type="text/css" href="css/base.css">
					<link href="css/Query.css" rel="stylesheet" type="text/css">
						...
						<script language="javascript">
							function doShow(id) {
								var url = "finance/TransferBillInfoForCancel.html?id="
										+ id;
								ShowIframe("转账取款单作废", url, 900, 300,
										"refreshWin()", 900, 600);
							}
							function refreshWin() {
								if (popRetVal != null) {
							...
							function doDisabled(id) {
								...
								ShowIframe("转账取款单作废", url, 600, 260,
										"doDisabledCallback(" + id + ")");
							}
							function doDisabledCallback(id) {
								if (popRetVal != null) {
									$.post("finance/TransferBillCancel.html", {
										id : id,
										reason : popRetVal,
										show_aler : "Y"
							...
							function doSearch() {
								...
								window.location = "finance/TransferBillListForCancel.html?ts_id="
										+ tsId + "&search_key=" + searchKey;
							}
							function doGo(pageIndex) {
								var searchKey = encodeURIComponent("");
								window.location = "finance/TransferBillListForCancel.html?ts_id=1&search_key="
										+ searchKey
										+ "&current_page="
										+ pageIndex;
							}
...
<body oncontextmenu="return false" onload="doInit();" class="sheet"
	...
	<div class="sheet-main"
		...
		<div class="sheet-top">
			<div class="content">
				<h2>转账取款作废</h2>
				<p>转账取款单作废相当于删除操作，一旦作废，该转账取款单将不可以恢复</p>
			</div>
		</div>
				...
				<div class="table-list">
					<table width="100%">
						<tbody>
							...
							<s:iterator value="transferBill" var="transferBill">
								<tr>
									<td>${billCode }</td>
									<td><s:date name="transferDate" format="yyyy-MM-dd"></s:date></td>
									<td></td>
									<td>${toAccountId }</td>
									<td>取出账户</td>
									<td>存入账户</td>
									...
									<td>${managerName }</td>
									<td>${departmentId }</td>
									<td><s:if test=' #transferBill.examined.equals("Y") '>
										已审核
										</s:if> <s:elseif test=' #transferBill.examined.equals("N") '>
　　										未审核
										</s:elseif></td>
									<th width="10%">
										<a href="Accounts_disabledTransferBill?transferBill.id=${ id }">作废</a>
										<a href="Accounts_toDisabledTransferBill?transferBill.id=${id }">查看</a>
									</th>
								</tr>
							</s:iterator>
						</tbody>
