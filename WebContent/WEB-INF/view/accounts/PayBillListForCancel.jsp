...
<!-- saved from url=(0058)http://115.28.87.22:8888/finance/PayBillListForCancel.html -->
	...
	<meta http-equiv="Pragma" content="no-cache">
		<meta http-equiv="Cache-Control" content="no-cache">
			<meta http-equiv="Expires" content="0">
				<title>付款单作废 | 管理易-广告加工制作管理软件 企业版 9.28 | 易凯软件</title> <script
				...
				<link rel="stylesheet" type="text/css" href="css/base.css">
					<link href="css/Query.css" rel="stylesheet" type="text/css">
						...
						<script language="javascript">
							function doShow(id) {
								var url = "finance/PayBillInfoForCancel.html?id="
										+ id;
								ShowIframe("付款单作废", url, 900, 500,
										"refreshWin()", 900, 600);
							}
							function refreshWin() {
								if (popRetVal != null) {
							...
							function doSearch() {
								...
								window.location = "finance/PayBillListForCancel.html?ts_id="
										+ tsId + "&search_key=" + searchKey;
							}
							function doGo(pageIndex) {
								var searchKey = encodeURIComponent("");
								window.location = "finance/PayBillListForCancel.html?ts_id=1&search_key="
										+ searchKey
										+ "&current_page="
										+ pageIndex;
							}
...
<body oncontextmenu="return false" onload="doInit();" class="sheet"
	...
	<div class="sheet-main"
		...
		<div class="sheet-top">
			<div class="content">
				<h2>付款单作废</h2>
				<p>付款单作废相当于删除操作，一旦作废，该付款单将不可以恢复</p>
			</div>
		</div>
				...
				<div class="table-list">
					<table width="100%">
						<tbody>
							...
							<s:iterator value="payBills" var="payBills">
								<tr class="query_list_data_trSelected" index="1"
									...
									<td>
										<s:date name="payBills.payDate" format="yyyy-MM-dd"/>
									</td>
									<td>付款单位</td>
									<td>
										<s:if test=' #payBills.examined.equals("PURCHASE") '>
										采购付款
										</s:if> <s:elseif test=' #payBills.examined.equals("COOPER") '>
　　										外协付款
										</s:elseif>
									</td>
									<td>${cost }</td>
									...
									<td>${managerName }</td>
									<td>
										<s:if test=' #payBills.examined.equals("Y") '>
										已审核
										</s:if> <s:elseif test=' #payBills.examined.equals("N") '>
　　										未审核
										</s:elseif>
									</td>
									<td><a href="Accounts_disabledPayBill?payBill.id=${ id }">作废</a>
										<a href="Accounts_toDisabledPayBill?payBill.id=${id}">查看</a></td>
								</tr>
							</s:iterator>
						</tbody>
					</table>
					...
					<div class="table-bot">
						...
						<img src="images/but001.gif"> <img src="images/but002.gif">
								...
								class="TextBox"> 页 共1页 <img src="images/but003.gif">
