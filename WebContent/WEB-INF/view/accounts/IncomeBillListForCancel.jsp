...
<!-- saved from url=(0061)http://115.28.87.22:8888/finance/IncomeBillListForCancel.html -->
	...
	<meta http-equiv="Pragma" content="no-cache">
		<meta http-equiv="Cache-Control" content="no-cache">
			<meta http-equiv="Expires" content="0">
				<title>其他收入作废 | 管理易-广告加工制作管理软件 企业版 9.28 | 易凯软件</title> <script
				...
				<link rel="stylesheet" type="text/css" href="css/base.css">
					<link href="css/Query.css" rel="stylesheet" type="text/css">
						...
						<script language="javascript">
							function doShow(id) {
								var url = "finance/IncomeBillInfoForCancel.html?id="
										+ id;
								ShowIframe("其他收入单作废", url, 900, 300,
										"refreshWin()", 900, 600);
							}
							function refreshWin() {
								if (popRetVal != null) {
							...
							function doDisabled(id) {
								...
								ShowIframe("其他收入单作废", url, 600, 260,
										"doDisabledCallback(" + id + ")");
							}
							function doDisabledCallback(id) {
								if (popRetVal != null) {
									$.post("finance/IncomeBillCancel.html", {
										id : id,
										reason : popRetVal,
										show_aler : "Y"
							...
							function doSearch() {
								...
								window.location = "finance/IncomeBillListForCancel.html?ts_id="
										+ tsId + "&search_key=" + searchKey;
							}
							function doGo(pageIndex) {
								var searchKey = encodeURIComponent("");
								window.location = "finance/IncomeBillListForCancel.html?ts_id=1&search_key="
										+ searchKey
										+ "&current_page="
										+ pageIndex;
							}
...
<body oncontextmenu="return false" onload="doInit();" class="sheet"
	...
	<div class="sheet-main"
		...
		<div class="sheet-top">
			<div class="content">
				<h2>其他收入作废</h2>
				<p>其他收入单作废相当于删除操作，一旦作废，该其他收入单将不可以恢复</p>
			</div>
		</div>
								...
								<td>
									<div align="right">
										<input type="text" class="TextBox" id="search_key"
											...
											title="以收入类型、经办人、单号、付款单位进行模糊查询"> <select name="ts_id"
											id="ts_id">
											...
											class="buttom search-but" title="以收入类型、经办人、单号、付款单位进行模糊查询">
									</div>
								</td>
							</tr>
						</tbody>
				...
				<div class="table-list">
					<table width="100%">
						<tbody>
							...
							<s:iterator value="incomeBills" var="incomeBill">
								<tr>
									<th width="15%">${billCode }</th>
									<th width="10%"><s:date name="incomeDate"
											format="yyyy-MM-dd" /></th>
									<th width="10%">
									<s:if test=' #incomeBill.payModeId.equals(1) '>现结</s:if>
									<s:if test=' #incomeBill.payModeId.equals(2) '>月结</s:if>
									<s:if test=' #incomeBill.payModeId.equals(3) '>季结</s:if>
									<s:if test=' #incomeBill.payModeId.equals(4) '>公户转帐</s:if>
									<s:if test=' #incomeBill.payModeId.equals(5) '>支付宝转帐</s:if>
									<s:if test=' #incomeBill.payModeId.equals(6) '>银行转帐</s:if>
									<s:if test=' #incomeBill.payModeId.equals(7) '>物流代收</s:if>
									<s:if test=' #incomeBill.payModeId.equals(8) '>微信转帐</s:if>
									<s:if test=' #incomeBill.payModeId.equals(9) '>取货付款</s:if>
									</th>
...
　　										未审核
									...
									<th width="10%">
										<a href="Accounts_disabledIcomeBill?incomeBill.id=${ id }">作废</a>
										<a href="Accounts_toDisabledIncomeBill?incomeBill.id=${id }">查看</a>
									</th>
								</tr>
							</s:iterator>
						</tbody>
