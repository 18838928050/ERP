...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<meta http-equiv="Pragma" content="no-cache">
		<meta http-equiv="Cache-Control" content="no-cache">
			<meta http-equiv="Expires" content="0">
				<title>收款单作废 | 管理易-广告加工制作管理软件 企业版 9.28 | 易凯软件</title> <script
	...
	function doShow(id){
		var url="finance/ReceiveBillInfoForCancel.html?id="+id;
		ShowIframe("收款单作废",url,900,500,"refreshWin()",900,600);
	}
	function refreshWin(){
		if(popRetVal!=null){
	...
	function doDisabled(id){
		...
		ShowIframe("收款单作废",url,600,260,"doDisabledCallback("+id+")");
	}
	function doDisabledCallback(id){
		if(popRetVal!=null){
			$.post("finance/ReceiveBillCancel.html",{id:id,reason:popRetVal,show_aler:"Y"},function(data,status){
...
<body oncontextmenu="return false" onload="doInit();" class="sheet"
	...
	<div class="sheet-main"
		...
		<div class="sheet-top">
			<div class="content">
				<h2>收款单作废</h2>
				<p>收款单作废相当于删除操作，一旦作废，该收款单将不可以恢复</p>
			</div>
		</div>
						...
						<tbody>
							...
							<s:iterator value="receiveBills" var="receiveBills" status="st">
								<tr class="query_list_data_trSelected" index="1"
									...
									<td><input type="radio" name="query_checkbox" value="2040"
									...
									<td>${ description }</td>
									<td>${ managerName }</td>
									<td><s:if test=' #receiveBills.examined.equals("Y") '>
										已审核
										</s:if> <s:elseif test=' #receiveBills.examined.equals("N") '>
　　										未审核
										</s:elseif></td>
										<td><a href="Accounts_disabledReceiveBill?receiveBill.id=${ id }">作废</a>
										<a href="Accounts_toDisabledReceiveBill?receiveBill.id=${id }">查看</a></td>
								</tr>
					...
					<div class="table-bot">
						<img src="images/but001.gif"> <img src="images/but002.gif">
								...
								class="TextBox"> 页 共203页 <a style="cursor: pointer"
									onclick="javascript:doGo(&quot;2&quot;);"><img
										src="images/but003.gif"></a> <a style="cursor: pointer"
									onclick="javascript:doGo(&quot;203&quot;);"><img
