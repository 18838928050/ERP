...
<!-- saved from url=(0068)http://115.28.87.22:8888/finance/LoanBillListForCancel.html?type=OUT -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta http-equiv="Pragma" content="no-cache">
<meta http-equiv="Cache-Control" content="no-cache">
<meta http-equiv="Expires" content="0">
<title>资金借出单作废 | 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
...
<script language="javascript">
	function doShow(id){
		var url="finance/LoanBillInfoForCancel.html?id="+id;
		ShowIframe("资金借出单作废",url,900,300,"refreshWin()",900,600);
	}
	function refreshWin(){
		if(popRetVal!=null){
	...
	function doDisabled(id){
		...
		ShowIframe("资金借出单作废",url,600,260,"doDisabledCallback("+id+")");
	}
	function doDisabledCallback(id){
		if(popRetVal!=null){
			$.post("finance/LoanBillCancel.html",{id:id,reason:popRetVal,show_aler:"Y"},function(data,status){
...
<div class="sheet-main" style="width:860px;text-align:left;margin:auto;">
  <div class="sheet-top">
    <div class="content">
      <h2>资金借出单作废</h2>
      <p>资金借出单作废相当于删除操作，一旦作废，该资金借出单将不可以恢复</p>
    </div>
  </div>
...
　　										未审核
									...
									<td>
										<a href="Accounts_disabledOutLoanBill?loanBill.id=${ id }">作废</a>
										<a href="Accounts_toDisabledOutLoanBill?loanBill.id=${id }">查看</a>
									</td>
								</tr>
							</s:iterator>
				</tbody></table>
