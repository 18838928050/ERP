...
<div class="sheet-main" id="bodyDiv" style="width:370px;">
	<form name="frm" action="UserRole_UserNew" method="post">
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;currentPassword&#39;);" id="user.userName" name="userName" value="">
					          <script language="javascript">
					          	setFormErrorMsg('',1,'user.userName');
					          </script>
				     	</td>
					</tr>
					<tr>
				      	...
				      	<td>
				      		<input type="text" class="TextBox" maxlength="15" id="currentPassword" name="password" value="">
