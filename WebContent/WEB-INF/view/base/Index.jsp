			...
			<div class="nav-link">
				<div>
					<script language="javascript">
						...
						//外协商登记-w
						d.add(401, 4, '外协商登记', "javascript:showCooperatorDialog(1024,600,'waixieshang_toAddCooperNew');", '', '', '', false);
						...
						d.add(810, 8, '产值单11122', "javascript:showWin(1024,420,'make/OvBillNew.html?alert_type=SHOW');", '', '', '', false);
						...
						d.add(813, 8, '产值单一览表333', "javascript:showWin(900,600,'make/OvBillSearchResult.html');", '', '', '', false);
