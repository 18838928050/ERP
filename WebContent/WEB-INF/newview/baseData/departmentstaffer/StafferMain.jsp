	...
	<body oncontextmenu="return false" class="sheet" onload="doInit();" scroll="no">
		<div class="sheet-main">
			...
			<div class="blank24"></div>
				<div class="nav" id="leftDiv" style="float:left;width:20%;height:100%;border:1px solid #CCCCCC;">
					<iframe id="leftFrame" scrolling="no" src="departStaff_toDepartmentList" height="508px" frameborder="0" width="100%"></iframe>
				</div>
				<div class="main search-business" id="rightDiv" style="float: right; height: 100%; width: 78%; border:1px solid #CCCCCC;">
