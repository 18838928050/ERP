...
<html>
	...
	<body scroll="no" onload="showMe();" class="sheet modal-dialog">
		<div class="sheet-main" id="bodyDiv">
			<form class="layui-form" action="customerType_updateCustomerTypeEdit" method="post">
			
			<input  name="id" value="${customTypes.id }" hidden />
							...
							<div style="margin: 0 auto; width: 405px;">
								<div class="layui-form-item">
									...
									<div class="layui-input-inline">
										<input class="layui-input" placeholder="" type="text" maxlength="15" onkeyup="goNextInput(&#39;currentPassword&#39;);" id="typeName" name="typeName" value="${customTypes.typeName }">
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label"><span class="MustInput">*</span>序号：</label>
									<div class="layui-input-inline">
										<input class="layui-input"  placeholder="" type="text" maxlength="15" id="sequenceCode" name="sequenceCode" value="${customTypes.sequenceCode }">
									</div>
								</div>
							</div>
							</tbody>
				...
				<div class="modal-buttom" id="buttonDiv">
					...
					<input type="submit" class="buttom-a" value="保存并新增" onclick="doSave(&#39;1&#39;);">
