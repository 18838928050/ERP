...
<!-- saved from url=(0061)http://115.28.87.22:8888cooper/GatherBillListForExamine.html -->
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>收货单审核 | 管理易-广告加工制作管理软件 企业版 9.28 | 易凯软件</title>
		...
		<script language="javascript">
			function doShow(id) {
				var url = "gatherE_toGatherBillInfo?id=" + id;
			...
			function doExamineCallBack(id) {
				if(popRetVal != null) {
					var url = "cooper/GatherBillExamine.html?id_str=" + id + "&flag=1";
			...
			function doMutiExamine() {
				...
				if(str != "") {
					...
					ShowAlert('请选择要审核的收货单', {title:'提示框'});
				}
			}
			...
			function doSearch() {
				...
				window.location = "cooper/GatherBillListForExamine.html?ts_id=" + tsId + "&search_key=" + searchKey;
			}

			function doGo(pageIndex) {
				var searchKey = encodeURIComponent("");
				window.location = "cooper/GatherBillListForExamine.html?ts_id=2&search_key=" + searchKey + "&current_page=" + pageIndex;
			}
		...
		<div class="sheet-main">
			...
			<div class="sheet-list">
				<div class="search-business">
					...
					<p style="line-height: 25px;">对收货单进行审核操作</p>
					<div class="table-list">
						<table width="100%">
							<tbody>
								...
								<td>${createrName}</td>
								<td>
							    <a href="javascript:doExamine('30');">审核通过</a>
							    <a href="javascript:doShow('${id}');">查看</a>
						        </td>
								</tr>
								</s:iterator>
						...
						<div class="table-bot clearfix">
							<div class="pull-right">
								...
								第
								<div class="layui-input-inline">
									<input class="layui-input" style="width:30px;padding-left: 1px;text-align: center;" placeholder="" type="text" maxlength="15" onkeydown="javascript:doJump(this.value);" id="confirmPassword" name="pageNumber" value="1">
								</div>
								页&nbsp;&nbsp;共1页
