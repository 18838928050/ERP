			...
			<form name="frm" method="post">
				<div class="Container">
					<div class="Contnet Paper">
								...
								<div class="layui-col-sm4 tr" style="">
									...
									<div class="layui-form-item" style="display: inline-block;">
										...
										<div class="layui-input-inline" style="width: 104px;">
											<input type="text" class="layui-input disabled readonly" readonly="readonly" maxlength="30" onkeyup="goNextInput('deliverDateStr');" id="gatherBill.billCode" name="gatherBill.billCode" value="G(1)2017110004">
										<script language="javascript">
									...
									<div class="layui-form-item" style="display: inline-block;">
										...
										<div class="layui-input-inline" style="width: 85px;">
											<input type="text" class="layui-input" maxlength="15" onkeyup="goNextInput('gatherBill.linkman');" id="gatherDateStr" name="gatherDateStr" value="2017-11-27">
										<script language="javascript">
							...
							<tbody id="itemRowTbl">
								...
								<tr id="itemTr0">
									<td>
										...
										<input type="hidden" id="id_0" name="id_0" value="53">
										<input type="hidden" id="cb_item_id_0" name="cb_item_id_0" value="94">
									</td>
									<td>
										<input type="text" class="layui-input readonly" readonly="readonly" style="width:110px" id="cont_0" name="cont_0" value="A-2钛金展示牌">
									</td>
									<td>
										<input type="text" class="layui-input readonly" readonly="readonly" style="width:110px" id="pro_name_0" name="pro_name_0" value="">
									</td>
									<td>
										<input type="text" class="layui-input readonly" readonly="readonly" style="width:110px" id="spe_0" name="spe_0" value="600*800mm">
									</td>
									<td>
										<input type="text" class="layui-input readonly" readonly="readonly" style="width:180px" id="req_0" name="req_0" value="">
									</td>
									<td>
										<input type="text" class="layui-input readonly" readonly="readonly" style="width:68px" id="amount_total_0" name="amount_total_0" value="2">
									</td>
									<td>
										<input type="text" class="layui-input" style="width:68px" maxlength="10" id="amount_0" name="amount_0" value="2">
									</td>
								</tr>
							...
							<table class="BillElseInfo" cellspacing="0" cellpadding="0">
								<tbody>
									<tr>
										...
										<td width="273px">
											<input type="text" class="tbInfo2 layui-input" maxlength="200" onkeyup="goNextInput('gatherBill.mark');" id="gatherBill.content" name="gatherBill.content" value="东厂 长通物流发货 代收180元">
											<script language="javascript">
						...
						<br>
						<div class="BillNotes">
							<span>开单人：邵丽萍 2017-11-27 13:53</span>
							<span>审核人：邵丽萍 2017-11-27 13:53</span>
							<span>单据帐套：新异</span>
					...
					<div class="Footer">
						<div id="buttonDiv">
							...
							<input type="button" class="buttom-a" value=" 打 印 " onclick="doPrint(43,0.00);">

							<input type="button" class="buttom-a" value=" 保 存 " onclick="doSave();" disabled="true">
							...
							<input type="hidden" name="sychronizeValue" value="1511762013000">
						</div>
