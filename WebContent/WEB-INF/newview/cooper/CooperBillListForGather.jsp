			...
			<div class="sheet-top">
				<div class="content">
					...
					<div class="pull-right">
						...
						<input type="text" class="TextBox" id="search_key" name="search_key" onkeyup="checkSearchKey();" style="width:80px" value="" title="以外协单位名称、外协单位拼音字头、摘要、外协单号进行模糊查询">
						<a type="button" class="buttom btn btn-default" href="#">查 询</a>
						<a type="button" class="buttom btn btn-default" href="#">收 货</a>
						<a type="button" class="buttom btn btn-default" href="#">短 信</a>
					</div>
				</div>
			</div>
