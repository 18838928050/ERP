...
<!-- saved from url=(0062)http://115.28.87.22:8888/business/DeliverBillSearchResult.html -->
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<meta http-equiv="Pragma" content="no-cache">
		<meta http-equiv="Cache-Control" content="no-cache">
			<meta http-equiv="Expires" content="0">
				<title>送货单一览表 | 管理易-广告加工制作管理软件 企业版 9.28 | 易凯软件</title> <script
	...
	function doShow(id){
		var url="business/DeliverBillEdit.html?id="+id;
		ShowIframe("送货单",url,1024,500,"refreshWin()",1024,600);
	}
	function refreshWin(){
		if(popRetVal!=null){
	...
	function createPageParaStr(){
		...
		str=str+"&et="+document.getElementById("et").value;
		str=str+"&el="+document.getElementById("el").value;
	...
	function doSearch(){
		...
		if(IsAdvSearch){//高级
			...
			if(document.getElementById("cb_deliver_date").checked){
		...
		window.location="business/DeliverBillSearchResult.html?"+str;
	}
	...
	function doDownload(){
		var str=getSearchCondition();
		window.location="business/DeliverBillSearchResult.html?content_type=EXCEL&"+str;
	}
	function doCancel(){
		window.close();
	}
	...
	function doPrint(id,favCost){
		...
		//if(favCost==0){
			ShowConfirm('确认框','送货单打印金额？',340,80,"doPrintCallBack("+id+")");
		//}
	...
	function doPrintCallBack(id){
		...
		showWin(900,600,"business/DeliverBillPrint.html?id="+id+"&print_cost="+printCost);
	}
	...
	function setDate(type){
		...
		doAutoCheck("cb_deliver_date");
	}
	function showExaPage(id){
		var url="business/DeliverBillInfoForExamine.html?id="+id;
	...
	function doMultiPrint(){
		ShowIframeNoScroll("选择打印类型","business/DeliverBillPrintSelect.html",330,280,"showPrintSelectCallBack()");
	}
		...
		if(popRetVal!=null){
			...
			for (i=0;i<ob_arr.length;i++){
				if ((ob_arr[i].checked == true)){
					...
					ids = ids+ob_arr[i].value;
				}
			}
			
			if(ids!=""){
				var type="IDS_"+popRetVal;
				showWin(900,600,"business/DeliverBillPrintMulti.html?type="+type+"&ids="+ids);
			}else{
				var str="type="+popRetVal;
				var searchType="1";
				if(searchType=="1"){//高级
					
						str=str+"&start_date="+encodeURIComponent(document.getElementById("hid_start_date").value);
						str=str+"&end_date="+encodeURIComponent(document.getElementById("hid_end_date").value);
				...
				showWin(900,600,"business/DeliverBillPrintMulti.html?"+str);
			}
		}
	}
	...
	function doEditDeli(id){
		var url="business/SetDeliCodeForm.html?bill_id="+id;
		ShowIframeNoScroll("填物流单号",url,360,240,"refreshWin()");
	}
...
<body oncontextmenu="return false">
	<div class="Wrap">
		...
		<div id="ListContainer" class="Container" style="width: 984px;">
			<!-- 主体容器 -->
			...
			<div class="Heading BillIcon">
				<div class="HeadingContent">
					<h1>送货单一览表</h1>
					<span class="Note">通过查询送货单，可以对送货单进行编辑与打印，同个客户的送货单可以自动合并成一张单打印，<span
						style="color: black">黑色</span>表示未审核、<span style="color: blue">蓝色</span>表示已审核
					</span>
				</div>
			</div>
					...
					<span class="fl">
							...
							<tbody>
								<tr>
									<th class="c1" width="80px"><input type="checkbox"
										name="cb_deliver_date" id="cb_deliver_date" checked="true"
										style="visibility: hidden;"> 送货日期 </th>
									<td width="360px"><input type="text"
										class="TextBox Datetime" maxlength="15"
										onkeyup="checkInput();"
										onfocus="doAutoCheck(&#39;cb_deliver_date&#39;);"
										id="start_date" name="start_date" value="2017-07-05">
											<img src="images/calendar.gif" class="imgIconButton"
											onclick="displayCalendar(document.getElementById(&#39;start_date&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_deliver_date\&#39;)&#39;);">
												<input type="hidden" id="hid_start_date" value="2017-07-05">
													...
													id="end_date" name="end_date" value="2017-07-05"> <img
														...
														onclick="displayCalendar(document.getElementById(&#39;end_date&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_deliver_date\&#39;)&#39;);">
						...
						class="buttom search-but" id="sSearchButton" name="sSearchButton">
							...
							name="sDownloadButton"> <input type="button" value=" 打 印"
								onclick="doMultiPrint();" class="buttom search-print"
							...
							<tbody>
								<tr>
									...
									<th class="c2" width="80px"><input type="checkbox"
										name="cb_examine" id="cb_examine"> 审核状态 </th>
									<td class="c2" width="210px"><input type="radio"
										name="examined" id="examine1"
										onclick="doAutoCheck(&#39;cb_examine&#39;);" checked="true">已审核
											<input type="radio" name="examined" id="examine2"
											onclick="doAutoCheck(&#39;cb_examine&#39;);">未审核 <input
												type="radio" name="examined" id="examine3"
												onclick="doAutoCheck(&#39;cb_examine&#39;);">全部 </td>
									<th class="c3" width="80px"><input type="checkbox"
										name="cb_dep" id="cb_dep"> 部门 </th>
									<td class="c3" width="180px"><select name="department"
										id="department" onfocus="doAutoCheck(&#39;cb_dep&#39;);">
								...
								<tr>
									...
									<th class="c2"><input type="checkbox" name="cb_deli"
										id="cb_deli"> 交货 </th>
									<td class="c2"><input type="radio" name="deli" id="deli1"
										onclick="doAutoCheck(&#39;cb_deli&#39;);">按时 <input
											type="radio" name="deli" id="deli2"
											onclick="doAutoCheck(&#39;cb_deli&#39;);">超期 <input
												type="radio" name="deli" id="deli3"
												onclick="doAutoCheck(&#39;cb_deli&#39;);" checked="true">全部
											</td>
									<th class="c3"><input type="checkbox" name="cb_area"
										id="cb_area"> 地区 </th>
								...
								<tr>
									...
									<th class="c2"><input type="checkbox" name="cb_manager"
										id="cb_manager"> 业务员 </th>
									<td class="c3"><input type="text" class="TextBox"
										maxlength="15" name="manager_name" id="manager_name"
										onkeyup="checkInput();"
									...
									<th class="c3"><input type="checkbox" name="cb_et"
										id="cb_et"> 客户类别 </th>
									<td class="c3"><select name="et" id="et"
										onfocus="doAutoCheck(&#39;cb_et&#39;);">
											<option value="0">==请选择==</option>
									...
									<td class="c3"><input type="text" class="TextBox"
										...
										onfocus="doAutoCheck(&#39;cb_creater&#39;);" value="">
											...
											onclick="selectStafferName(&#39;creater_name&#39;,&#39;cb_creater&#39;);">
												<input type="hidden" id="hid_creater_name" value=""></td>
									<th class="c3"><input type="checkbox" name="cb_el"
										id="cb_el"> 客户等级 </th>
									<td class="c3"><select name="el" id="el"
						...
						<div class="OptionOrderBy">
							<input type="checkbox" name="cb_order" id="cb_order">
								...
								onfocus="doAutoCheck(&#39;cb_order&#39;);">
									...
									<option value="DELIVER_DATE">送货日期</option>
								...
								<s:iterator value="businessBills" var="businessBill" status="st">
									<s:if test='#deliverBill.businessBillId==#businessBill.id'>
										<tr class="query_list_data_tr2" index="10"
											...
											<td>${deliverBill.deliComp}<br>${deliverBill.deliCode}</td>
											<td>${businessBill.createrName }</td>
											<td>${deliverBill.createrName }</td>
											<s:if test=' #deliverBill.examined.equals("Y") '>
												<td>已审核</td>
											</s:if>
											<s:elseif test=' #deliverBill
											.examined.equals("N") '>
												<td>未审核</td>
											</s:elseif>
	...
	(function(){
	    ...
	    lnkMoreOption.onclick = function(){
	        ...
	        document.getElementById('cb_deliver_date').style.visibility = 'visible';
	        this.style.visibility = 'hidden';
	    };
	    lnkHiddenOption.onclick = function(){
	    	IsAdvSearch = false;
	        document.getElementById('dvMoreOptionBox').style.display = 'none';
	        document.getElementById('cb_deliver_date').style.visibility = 'hidden';
