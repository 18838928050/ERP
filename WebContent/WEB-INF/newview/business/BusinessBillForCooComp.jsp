...
<script language="javascript">
	...
	function doShow(id){
		var url="cooper_toCooperCompLook?id="+id;
	...
	<div id="ListContainer" class="Container" style="width: 1326px;"><!-- 主体容器 -->
		...
		<div class="Content">
	        ...
	        <div class="FilterBar ClearFix">
				...
				<span class="fr">
	            	<a href="javascript:;" id="lnkMoreOption" style="visibility: visible;">更多查询选项</a>
				...
				<div id="dvMoreOptionBox" class="MoreOptionBox" style="display: none;">
					<table class="MoreOption" cellpadding="0" cellspacing="0">
						<tbody><tr>
			    			...
			    			<td width="240px">
								...
								<img src="./BusinessBillForCooComp_files/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;start_date&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_order_date\&#39;)&#39;);">
								...
								<img src="./BusinessBillForCooComp_files/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;end_date&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_order_date\&#39;)&#39;);">
			    			...
			    			<td class="c3" width="280px">
								...
								<img class="imgIconButton" src="./BusinessBillForCooComp_files/make-a.gif" onclick="selectEstName();">
			    		...
			    		<tr>
			        		...
			        		<td>
								...
								<img src="./BusinessBillForCooComp_files/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;del_start&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_del_date\&#39;)&#39;);">
								...
								<img src="./BusinessBillForCooComp_files/calendar.gif" class="imgIconButton" onclick="displayCalendar(document.getElementById(&#39;del_end&#39;),&#39;yyyy-mm-dd&#39;,this,false,&#39;doAutoCheck(\&#39;cb_del_date\&#39;)&#39;);">
			    			...
			    			<td class="c3">
								...
								<img class="imgIconButton" src="./BusinessBillForCooComp_files/make-a.gif" onclick="selectStafferName(&#39;foll_name&#39;,&#39;cb_foll&#39;);" style="cursor:pointer;">
						...
						<tr>
			    			...
			    			<td class="c1">
			        			<select name="ts_id" id="ts_id" onfocus="doAutoCheck(&#39;cb_ts&#39;);" style="visibility: hidden;">
					...
					<div class="OptionOrderBy">
						<input type="checkbox" name="cb_order" id="cb_order">
	                    	排序类型
	                    <select name="order_by" id="order_by" onfocus="doAutoCheck(&#39;cb_order&#39;);" style="visibility: hidden;">
						  	<option value="">==请选择==</option>
						  	<option value="ORDER_DATE">订货日期</option>
						  	<option value="DELIVER_DATE">交货日期</option>
						  	<option value="BILL_CODE">业务单号</option>
				  		</select>
	                    <select name="order_sc" id="order_sc" onfocus="doAutoCheck(&#39;cb_order&#39;);" style="visibility: hidden;">
...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
    ...
    <div class="table-bot">
    	  ...
    	  <img src="./BusinessBillForCooComp_files/but001.gif">
    	  <img src="./BusinessBillForCooComp_files/but002.gif">
    	    	
    	第 <input type="text" name="pageNumber" style="width:30px" value="1" onkeydown="javascript:doJump(this.value);" class="TextBox"> 页 
    	共1页
		
		
        <img src="./BusinessBillForCooComp_files/but003.gif">
        <img src="./BusinessBillForCooComp_files/but004.gif">
...
<div class="sogoutip" style="z-index: 2147483645; visibility: hidden; display: none;"></div><div class="sogoubottom" id="sougou_bottom" style="display: none;"></div><div id="ext_stophi" style="z-index: 2147483647;"><div class="extnoticebg"></div><div class="extnotice"><h2>关闭提示 <a href="http://115.28.87.22:8888/cooper/BusinessBillListForCooComp.ihtm#" title="关闭提示" id="closenotice" class="closenotice">关闭</a></h2><p id="sogouconfirmtxt"></p>  <a id="sogouconfirm" href="http://115.28.87.22:8888/cooper/BusinessBillListForCooComp.ihtm#" class="extconfirm">确 认</a> <a id="sogoucancel" href="http://115.28.87.22:8888/cooper/BusinessBillListForCooComp.ihtm#" class="extconfirm">取 消</a></div></div><div id="ext_overlay" class="ext_overlayBG" style="display: none; z-index: 2147483646;"></div><iframe class="sogou_sugg_feedbackquan" frameborder="0" scrolling="no" src="./BusinessBillForCooComp_files/yun6.html" style="border: none; display: none; height: 84px; width: 100%; z-index: 2147483645; background: transparent;"></iframe><span id="dialogCase"><div id="dialogBoxBG" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 637px; z-index: 10001; opacity: 0.4; background-color: rgb(0, 0, 0);"></div><div id="dialogBox" style="border: 1px solid rgb(230, 239, 248); z-index: 10003; position: absolute; width: 900px; left: 232px; top: 55.5px;"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tbody><tr height="24" id="dialogBoxTitleTr" bgcolor="#E6EFF8"><td><table style="-moz-user-select:none;height:24px;" width="100%" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td width="6" height="24"></td><td id="dialogBoxTitle" style="color: rgb(0, 0, 0); font-size: 14px; font-weight: bold; text-align: left; cursor: move;">业务单外协完工&nbsp;</td><td id="dialogClose" width="20" align="right" valign="middle"><img id="dialogBoxClose" src="./BusinessBillForCooComp_files/dialogclose.gif" border="0" align="absmiddle" style="cursor:pointer;" title="关闭"></td><td width="6"></td></tr></tbody></table></td></tr><tr id="dialogTr" style="height:500px" valign="top"><td id="dialogBody" style="position:relative;"><iframe width="100%" style="height:500px" name="ifr_popup0" id="ifr_popup0" src="./BusinessBillForCooComp_files/BusinessBillInfoForCooComp.html" frameborder="0" scrolling="yes"></iframe><div id="iframeBG" style="position:absolute;top:0px;left:0px;width:1px;height:1px;z-index:10005;filter: alpha(opacity=00);opacity:0.00;background-color:#ffffff;"><div></div></div></td></tr></tbody></table></div><div id="dialogBoxShadow" style="z-index: 10001; position: absolute; opacity: 0.2; top: 60px; left: 228px; width: 902px; height: 526px; background: rgb(0, 0, 0);"></div></span></body></html>