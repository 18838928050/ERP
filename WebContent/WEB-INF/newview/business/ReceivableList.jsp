...
<title>客户应收款 | 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
...
<div class="Wrap"><!-- 页面主框架 -->
	...
	<div id="ListContainer" class="Container" style="width: 971px;"><!-- 主体容器 -->
	        ...
	        <div class="FilterBar ClearFix">
	            ...
	            <span class="fl">
	            	<table class="MoreOption" cellpadding="0" cellspacing="0">
	            		...
	            		<td class="c3" width="260px">
	            			<input type="text" class="TextBox" id="search_key" name="search_key" onkeyup="checkInput();" onfocus="doAutoCheck(&#39;cb_sk&#39;);" value="" title="以客户名称、客户拼音字头进行模糊查询">
	            ...
	            <span class="fr">
	            	...
	            	<!-- <a href="javascript:showSmsSubscribe();" style="color:green" title="设置应收款超过信用额度的客户，系统自动发送催款结账的短信。">手机提醒设置</a> -->
		  			...
		  			<input type="button" value=" 对 帐" onclick="doMutiAcc();" class="buttom search-print">
		  			<input type="button" value=" 导 出" onclick="doDownload();" class="buttom search-out">
					<input type="button" value=" 短 信" onclick="doMutiSms();" class="buttom search-sms">
	            </span>
				<div id="dvMoreOptionBox" class="MoreOptionBox" style="display:none;">
					<table class="MoreOption" cellpadding="0" cellspacing="0">
						<tbody><tr>
							<th class="c1" width="80px">
			        			<input type="checkbox" name="cb_cre" id="cb_cre">
			        			信用额度
			        		</th>
			        		<td class="c3" width="180px">
			        			<input type="radio" name="cre_type" id="cre_type1" onclick="doAutoCheck(&#39;cb_cre&#39;);">已超出
								<input type="radio" name="cre_type" id="cre_type2" onclick="doAutoCheck(&#39;cb_cre&#39;);">未超出
								<input type="radio" name="cre_type" id="cre_type3" onclick="doAutoCheck(&#39;cb_cre&#39;);" checked="true">全部
			    			</td>
...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
		        ...
		        <table width="100%">
					...
					<td><input type="checkbox" onclick="javascript:ClickCheck(this,true);" name="query_checkbox" value="425"></td>	
						...
						<td style="text-align:left">
							<a href="http://115.28.87.22:8888/business/ReceivableList.html#" onclick="showReceiveBillDialog(&#39;425&#39;);">收款</a>
							<a href="http://115.28.87.22:8888/business/ReceivableList.html#" onclick="showAdjustBillDialog(&#39;425&#39;);">调账</a>
							<!--<a href="javascript:doDetail('425');">查明细</a>-->
							<a href="javascript:doSms(&#39;425&#39;,&#39;河南双丰速开发有限责任公司&#39;,&#39;855320.00&#39;);">发短信</a>
							<br>
							<a href="javascript:doShow(&#39;425&#39;);">查看</a>
							<a href="javascript:doAccountList(&#39;425&#39;);">对帐</a>
							<a href="javascript:doBackCostList(&#39;425&#39;,&#39;河南双丰速开发有限责任公司&#39;);">回款记录</a>
						</td>
								</tr>
							</s:iterator>
				</tbody></table>
    ...
    <div class="table-bot">
        ...
        <a style="cursor:pointer" onclick="javascript:doGo(&quot;34&quot;);"><img src="images/but004.gif"></a>
    </div>
	        </div>
		</div>
	</div>
