...
<html lang="zh-CN">
	...
	<body class="sheet modal-dialog">
		<div class="sheet-main" id="bodyDiv">
			<form action="UserRole_UserNew" method="post">
							...
							<table align="center" class="table-a">
								<tbody>
									...
									<tr>
										<th>状态：</th>
										<td>
											<label class="radio-inline"><input type="radio" name="enabled" id="inlineRadio1" value="Y" checked>正常</label>
											<label class="radio-inline"><input type="radio" name="enabled" id="inlineRadio2" value="N">停用</label>
									...
									<tr>
										<th>设置有效期：</th>
										<td>
											<label class="radio-inline"><input type="radio" name="useValidity" id="inlineRadio1" value="Y" checked>是</label>
											<label class="radio-inline"><input type="radio" name="useValidity" id="inlineRadio2" value="N" >否</label>
										</td>
									</tr>
									<tr>
										<th>有效期至：</th>
										...
										<td>
											<input type="text" class="form-control Datetime" maxlength="15" onkeyup="goNextInput();" id="validityStr" name="validityStr" value="${validityStr }">
									...
									<tr>
										<th>使用时间控制：</th>
										<td>
											<label class="radio-inline"><input type="radio" name="timeLimit" id="inlineRadio1" value="Y" checked onclick="changeTl();">是</label>
											<label class="radio-inline"><input type="radio" name="timeLimit" id="inlineRadio2" value="N" onclick="changeTl();" checked>否</label>
										</td>
									</tr>
									<tr>
										<th>使用时间范围：</th>
									...
									<tr>
										<th>允许外网访问：</th>
										<td>
											<label class="radio-inline"><input type="radio" name="allowInternet" id="inlineRadio1" value="Y" checked>是</label>
											<label class="radio-inline"><input type="radio" name="allowInternet" id="inlineRadio2" value="N">否</label>
										</td>
									</tr>
									<tr>
										<th>使用手机APP：</th>
										<td>
											<label class="radio-inline"><input type="radio" name="useApp" id="inlineRadio1" value="Y" checked>是</label>
											<label class="radio-inline"><input type="radio" name="useApp" id="inlineRadio2" value="N">否</label>
										</td>
									</tr>
								</tbody>
							</table>
