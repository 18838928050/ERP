	        	...
	        	<tr>
	            	<td class="tr">
		            	...
		            	<span class="MustInput">*</span>日期：
		                    ...
		                    <input type="text" class="tbBillDate_sim TextBox " maxlength="15" onkeyup="goNextInput(&#39;loanBill.rpName&#39;);" id="loanDateStr" name="loanDateStr" value="2017-07-12">
	        	...
	        	<table class="BillElseInfo" cellspacing="0" cellpadding="0" style="position:relative;"><!-- ie6要在这里加position:relative下面的附件div才不会错位 -->
	        		<tbody><tr>
	            		...
	            		<td width="217px">
							...
							<input class="tbInfo_sim TextBox" type="text" maxlength="15" onkeyup="goNextInput(&#39;costStr&#39;);" id="loanBill.rpName" name="loanBill.rpName" value="管理员">
					        <script language="javascript">
	            		...
	            		<td width="217px">
							...
							<input class="tbInfo_sim TextBox readonly" type="text" id="loanBill.managerName" name="loanBill.managerName" value="管理员">
							
							<img class="make-a" src="images/make-a.gif" style="cursor:pointer;" onclick="selectStaffer();">
							
							<input type="hidden" id="loanBill.managerId" name="loanBill.managerId" value="-1">
					        <script language="javascript">
					          	setFormErrorMsg('',4);
					        </script>
