...
<!-- saved from url=(0064)http://115.28.87.22:8888/finance/IncomeBillListForUnExamine.html -->
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>其他收入反审核 | 管理易-广告加工制作管理软件 企业版 9.28 | 易凯软件</title>
		...
		<script language="javascript">
			function doShow(id) {
				...
				ShowIframe(['900px', '300px'], url, '', function() {
					refreshWin();
				}, '其他收入单反审核');
			}
			...
			function doExamineCallBack(id) {
				if(popRetVal != null) {
					var url = "ReceiveBill_unReceiveBillExmin?receiveBill.id="+id;
			...
			function doSearch() {
				...
				window.location = "finance/IncomeBillListForUnExamine.html?ts_id=" + tsId + "&search_key=" + searchKey;
			}

			function doGo(pageIndex) {
				var searchKey = encodeURIComponent("");
				window.location = "finance/IncomeBillListForUnExamine.html?ts_id=1&search_key=" + searchKey + "&current_page=" + pageIndex;
			}
						...
						<div class="layui-form" style=" display: inline-block;">
							<div class="layui-inline">
								<div class="layui-input-inline">
									<input type="text" class="layui-input" id="search_key" name="search_key" onkeyup="checkSearchKey();" title="以收入类型、经办人、单号、付款单位进行模糊查询">
								</div>
							</div>
							<div class="layui-inline">
							...
							<a type="button " class="layui-btn " onclick="doSearch();" title="以收入类型、经办人、单号、付款单位进行模糊查询">查 询</a>
						...
						<table width="100%">
							<tbody>
								...
								<tr class="query_list_data_tr1" index="${index.indexs }" style="cursor:pointer;" ondblclick="javascript:DoubleClick(this)" onclick="javascript:ClickCheck(this,true)" onmouseout="javascript:mouseout(this)" onmouseover="javascript:mouseover(this)">
									<td><input type="checkbox" onclick="javascript:ClickCheck(this,true);" name="query_checkbox" value="${id }"></td>
									<td>${billCode }</td>
										<td>${receiveDate }</td>
										<td>
