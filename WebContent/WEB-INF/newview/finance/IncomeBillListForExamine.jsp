	...
	<head>
		...
		<script language="javascript">
			...
			function doExamineCallBack(id) {
				if(popRetVal != null) {
					var url = "InComeBill_canExamine?id="+id;
						...
						<table width="100%">
							<tbody>
								...
								<tr class="query_list_data_tr1" index="${index.indexs }" style="cursor:pointer;" ondblclick="javascript:DoubleClick(this)" onclick="javascript:ClickCheck(this,true)" onmouseout="javascript:mouseout(this)" onmouseover="javascript:mouseover(this)">
									<td><input type="checkbox" onclick="javascript:ClickCheck(this,true);" name="query_checkbox" value="${id }" cost="${cost }"></td>
										<td>${billCode }</td>
										<td>${incomeDate }</td>
										<td>${incomeTypeId }</td>
										<td>${payerName }</td>
										...
										<td>${managerName }</td>
									<td>
										<a href="javascript:doExamine(${id });">审核通过</a>
										<a href="javascript:doShow(&#39;261&#39;);">查看</a>
