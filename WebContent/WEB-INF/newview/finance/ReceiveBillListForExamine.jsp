	...
	<head>
		...
		<script language="javascript">
			function doShow(id) {
				...
				ShowIframe(['900px','600px'], url, '', function(){
					popRetVal = 'Y';
					refreshWin();
				}, '收款单审核');
			}
			...
			function doExamineCallBack(id) {
				if(popRetVal != null) {
					var url = "ReceiveBill_receiveBillExmin?receiveBill.id="+id;
			...
			function doMutiExamine() {
				...
				if(str != "") {
					ShowConfirm('收款合计' + cost + '元，确定审核通过吗？', {title:'确认框'}, function(index){
						popRetVal = 'Y';
						doExamineCallBack(str);
						layer.close(index);
					});
				} else {
					ShowAlert('请选择要审核的单据', {title:'提示框'});
				}
			}
...
<!-- 
								<tr class="query_list_data_tr1" index="9" style="cursor:pointer;" ondblclick="javascript:DoubleClick(this)" onclick="javascript:ClickCheck(this,true)" onmouseout="javascript:mouseout(this)" onmouseover="javascript:mouseover(this)">
									...
									<td>黄秀娟</td>
									<td>
										<a href="javascript:doExamine(&#39;1856&#39;);">审核通过</a>
										<a href="javascript:doShow(&#39;1856&#39;);">查看</a>
