...
<body oncontextmenu="return false" onload="doInit();" class="sheet">
	<div class="sheet-main">
					...
					<div class="table-list">
						<table width="100%">
							<tbody>
								...
								<s:iterator value="transferBills" var="transferBill">
									<tr class="query_list_data_tr2" index="2"
										...
										<td><input type="radio" name="query_checkbox"
											value="2039" style="display: none"> ${billCode }</td>
										...
										<td>${cost }</td>
										<td>${managerName }</td>
										<s:if test=' #transferBill.examined.equals("Y") '>
											<td>已审核</td>
										</s:if>
										<s:elseif test=' #transferBill.examined.equals("N") '>
											<td>未审核</td>
										</s:elseif>
							...
							<div class="pull-right">
								...
								<div class="layui-input-inline">
									<input class="layui-input" style="width: 30px" placeholder=""
										...
										onkeydown="javascript:doJump(this.value);"
										id="confirmPassword" name="pageNumber" value="1">
								</div>
		...
		<script language="javascript">
			function doShow(id) {
				var url = "Accounts_toTransferBill?id=" + id;
			...
			function doDisabled(id) {
				var url = "Accounts_toDisabledTransferBill";
			...
			function doDisabledCallback(id) {
				if(popRetVal != null) {
					$.post("Accounts_disabledTransferBill", {
						id: id,
						reason: popRetVal,
						show_aler: "Y"
			...
			function doSearch() {
				...
				window.location = "finance/TransferBillListForCancel.html?ts_id=" + tsId + "&search_key=" + searchKey;
			}

			function doGo(pageIndex) {
				var searchKey = encodeURIComponent("");
				window.location = "finance/TransferBillListForCancel.html?ts_id=1&search_key=" + searchKey + "&current_page=" + pageIndex;
			}
