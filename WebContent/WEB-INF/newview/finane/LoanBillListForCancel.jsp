					...
					<div class="table-list">
						<table width="100%">
							<tbody>
								...
								<tr class="query_list_data_tr1" index="3" style="cursor:pointer;" ondblclick="javascript:DoubleClick(this)" onclick="javascript:ClickCheck(this)" onmouseout="javascript:mouseout(this)" onmouseover="javascript:mouseover(this)">
									<td>
										<input type="radio" name="query_checkbox" value="2038" style="display:none"> ${billCode }
									</td>
									...
									<s:if test=' #loanBill.examined.equals("Y") '>
										<td>已审核</td>
										</s:if> <s:elseif test=' #loanBill.examined.equals("N") '>
　　										<td>未审核</td>
										</s:elseif>
									<td>
										<a href="javascript:doDisabled(${ id });">作废</a>
		...
		<script language="javascript">
			function doShow(id) {
				var url = "Accounts_toInLoanBill?id=" + id;
			...
			function doDisabled(id) {
				var url = "Accounts_toDisabledInLoanBill";
			...
			function doDisabledCallback(id) {
				if(popRetVal != null) {
					$.post("Accounts_disabledInLoanBill", {
						id: id,
						reason: popRetVal,
						show_aler: "Y"
