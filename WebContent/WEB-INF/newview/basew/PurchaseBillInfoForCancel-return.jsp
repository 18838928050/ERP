...
<title>采购单反审核| 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
    ...
    <div class="modal-main search-business">
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="table-0">
			<tbody><tr>
				...
				<td style="width:33%;text-align:center" rowspan="2"><h2>采购单反审核</h2></td>
...
<td><s:property value="%{purchaseBillItemVOs[#s.index].mark}"/></td>	
		...
		<s:a  class="buttom-a" action="caigoudanfanshenhe_shenhebutongguo?purchaseBillVO.id=%{purchaseBillVO.id}">反审核</s:a>
<s:a action="caigoudanfanshenhe_tuichu" class="buttom-a">退出</s:a>
		</div>
   </div>
  </div>
