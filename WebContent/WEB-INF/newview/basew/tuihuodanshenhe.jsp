...
<s:iterator value="purchaseBillVOs" status="st">
		<tr>
			...
			<td>
			<s:a action="tuihuodanshenhe_shenhetongguo?purchaseBillVO.id=%{id}">审核通过</s:a>
			<s:a href="javascript:showWin(['900px', '600px'],'tuihuodanshenhe_chakan?purchaseBillVO.id=%{id}');">查看</s:a>
		<%-- 	<s:a action="tuihuodanshenhe_chakan?purchaseBillVO.id=%{id}">查看</s:a> --%>
			</td>
<td></td>
		</tr>
</s:iterator>
