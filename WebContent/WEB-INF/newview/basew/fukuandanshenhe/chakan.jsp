...
<title>付款单审核| 管理易-广告加工制作管理软件  企业版 9.28 | 易凯软件</title>
...
<script language="javascript">
	...
	function doDisabled(id){
		...
		ShowIframe("付款单审核",url,600,260,"doDisabledCallback("+id+")");
	}
    ...
    <div class="modal-main search-business">
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="table-0">
			<tbody><tr>
				...
				<td style="width:33%;text-align:center" rowspan="2"><h2>付款单审核</h2></td>
...
<tr>
       ...
       <s:elseif test=' payBillVO.payType.equals("COOPER") '>外协付款</s:elseif>
		...
		<s:a  class="buttom-a" action="paybillshenhe_ExaminedTongGuo?payBillVO.id=%{payBillVO.id}">审核通过</s:a>
<s:a action="paybillshenhe_tuichu" class="buttom-a">退出</s:a>
		</div>
   </div>
  </div>
