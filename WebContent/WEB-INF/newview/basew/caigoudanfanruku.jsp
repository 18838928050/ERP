    ...
    <div class="modal-main search-business">
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="table-0">
			<tbody><tr>
				...
				<td style="width:33%;text-align:center" rowspan="2"><h2>采购单取消入库</h2></td>
...
<td><s:property value="%{purchaseBillItemVOs[#s.index].mark}"/></td>	
	...
	<s:a action="caigoudanfanruku_caigoudanfanruku?purchaseBillVO.id=%{purchaseBillVO.id}">取消入库</s:a>
<s:a action="caigoudanfanruku_tuichu">退出</s:a>
		</div>
   </div>
  </div>
