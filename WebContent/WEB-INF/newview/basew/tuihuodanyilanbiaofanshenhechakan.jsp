...
<title>退货单一览表| 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
...
<script language="javascript">
	...
	function doDisabled(id){
		...
		ShowIframe("退货单一览表反审核",url,600,260,"doDisabledCallback("+id+")");
	}
    ...
    <div class="modal-main search-business">
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="table-0">
			<tbody><tr>
				...
				<td style="width:33%;text-align:center" rowspan="2"><h2>退货单一览表反审核</h2></td>
...
<s:a class="buttom-a" action="tuihuobiaofanshenhe_shenhebutongguo?purchaseBillVO.id=%{purchaseBillVO.id}">反审核</s:a>
<s:a class="buttom-a" action="tuihuobiaofanshenhe_tuichu">退出</s:a>
		</div>
   </div>
  </div>
</div>
