...
<title>费用单反审核| 管理易-广告加工制作管理软件  企业版 9.28 | 易凯软件</title>
...
<script language="javascript">
	...
	function doDisabled(id){
		...
		ShowIframe("费用单反审核",url,600,260,"doDisabledCallback("+id+")");
	}
    ...
    <div class="modal-main search-business">
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="table-0">
			<tbody><tr>
				...
				<td style="width:33%;text-align:center" rowspan="2"><h2>费用单反审核</h2></td>
		...
		<s:a  class="buttom-a" action="feebillfanshenhe_ExaminedNotTongGuo?feeBillVO.id=%{feeBillVO.id }">反审核</s:a>&nbsp;
<s:a action="feebillfanshenhe_toback?id=%{id}" class="buttom-a">退出</s:a>
		</div>
   </div>
  </div>
</div>
