...
<title>地区 | 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
...
<script language="javascript">
	function doNew(){
		var url="${pageContext.request.contextPath} /base/AreaNew.html?parent_id=0";
		ShowIframeNoScroll("地区",url,320,275,"refreshWin()");
	}
	function refreshWin(){
		window.location.reload(true);
	}
	function doEdit(id){
		var url="${pageContext.request.contextPath} /base/AreaEdit.html?id="+id;
		ShowIframeNoScroll("地区",url,320,275,"refreshWin()");
	}
	...
	function doDelAct(id){
		if(popRetVal!=null){
			window.location="${pageContext.request.contextPath}/base/AreaDelete.html?id="+id+"&from_url="+encodeURIComponent(window.location);
		}
	}
	function doSearch(){
		var parentId=document.getElementById("parent_id").value;
		window.location="${pageContext.request.contextPath}/base/AreaList.html?parent_id="+parentId;
	}
	function doCancel(){
		window.close();
	}
	function doBack(){
		window.location="${pageContext.request.contextPath}/base/AreaList.html?parent_id=";
	}
...
<div class="sheet-main" style="width:500px;text-align:left;margin:auto;">
  <div class="sheet-top">
    <div class="content">
      <h2>地区</h2>
      <p>应用于客户档案、供应商档案、外协商档案，方便分类查询与统计</p>
    </div>
  </div>
