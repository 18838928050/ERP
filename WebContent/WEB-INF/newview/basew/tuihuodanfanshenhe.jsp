...
<s:iterator value="purchaseBillVOs" status="st">
		<tr>
			...
			<td><s:a action="tuihuodanfanshenhe_shenhebutongguo?purchaseBillVO.id=%{id}">反审核</s:a>
			 <%-- <s:a action="tuihuodanfanshenhe_chakan?purchaseBillVO.id=%{id}">查看</s:a> --%>
			 	 <s:a href="javascript:showWin(['900px', '600px'],'tuihuodanfanshenhe_chakan?purchaseBillVO.id=%{id}');">查看</s:a>
			</td>
