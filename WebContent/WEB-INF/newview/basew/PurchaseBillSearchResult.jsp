...
<html lang="zh-CN">
	...
	<%--		
			...
			<s:if test='purchaseBillExtVOs[#st.index].examined=="Y"'><s:a action="javascript:showWin(['1000px', '600px'],'caigoubiaofanshenhe_chakan?purchaseBillVO.id=%{id}');">已审核</s:a></s:if>
			...
			<td>
			<s:if test='purchaseBillExtVOs[#st.index].examined=="Y"'>	<s:a href="javascript:showWin(['900px', '600px'],'caigoubiaofanshenhe_chakan?purchaseBillVO.id=%{id}');">已审核</s:a></s:if>
			<s:if test='purchaseBillExtVOs[#st.index].examined=="N"'><s:a href="javascript:showWin(['900px', '600px'],'caigoubiaoshenhe_chakan?purchaseBillVO.id=%{id}');">未审核</s:a>
			</s:if>
			
			<s:if test='purchaseBillExtVOs[#st.index].stoc=="Y"'>			<s:a href="javascript:showWin(['900px', '600px'],'caigoudanfanruku_fanruku?purchaseBillVO.id=%{id}');">已入库</s:a></s:if>
			<s:if test='purchaseBillExtVOs[#st.index].stoc=="N"'>			<s:a href="javascript:showWin(['900px', '600px'],'caigoudanruku_ruku?purchaseBillVO.id=%{id}');">未入库</s:a></s:if>
			<s:if test='cost-purchaseBillExtVOs[#st.index].paiedCost==0'>已结清</s:if>
			<s:if test='cost-purchaseBillExtVOs[#st.index].paiedCost!=0'><s:a action="caigoubiaoshenhe_chakan?purchaseBillVO.id=%{id}">未结清</s:a></s:if>
			</td>
