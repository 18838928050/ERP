...
<td><s:property value="%{purchaseBillItemVOs[#s.index].mark}"/></td>	
		...
		<s:a  class="buttom-a" action="caigoubiaofanshenhe_shenhebutongguo?purchaseBillVO.id=%{purchaseBillVO.id}">反审核</s:a>
<s:a action="caigoubiaofanshenhe_tuichu" class="buttom-a">退出</s:a>
		</div>
   </div>
  </div>
