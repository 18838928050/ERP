...
<title>退货单出库| 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
    ...
    <div class="modal-main search-business">
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="table-0">
			<tbody><tr>
				...
				<td style="width:33%;text-align:center" rowspan="2"><h2>退货单出库</h2></td>
...
<s:a   class="buttom-a"  action="tuihuodanchuku_tuihuodanchuku?purchaseBillVO.id=%{purchaseBillVO.id}">出库</s:a>
<s:a  class="buttom-a"  action="tuihuodanchuku_tuichu">退出</s:a>
		</div>
   </div>
  </div>
