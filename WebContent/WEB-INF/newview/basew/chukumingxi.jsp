...
<th>金额</th>
						...
						<tbody>
						<s:iterator value="outBillVOs" status="st">
<tr>
<td>${billCode }</td>
<td>${outDate }</td>
<td><s:property value="%{storehouseVOs[#st.index].stoName}"></s:property></td>
<td>${managerName }</td>
<td><s:property value="%{product.productCode}"></s:property></td>
<td><s:property value="%{product.productName}"></s:property></td>
<td><s:property value="%{product.unit}"></s:property></td>
<td><s:iterator value="%{purchaseBillItemVOs[#st.index]}">
