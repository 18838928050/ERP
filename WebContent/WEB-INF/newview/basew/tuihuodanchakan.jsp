...
<script language="javascript">
	...
	function doDisabled(id){
		...
		ShowIframe("采购单取消入库",url,600,260,"doDisabledCallback("+id+")");
	}
    ...
    <div class="modal-main search-business">
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="table-0">
			<tbody><tr>
				...
				<td style="width:33%;text-align:center" rowspan="2"><h2>退货单审核</h2></td>
...
<td><s:property value="%{purchaseBillItemVOs[#s.index].mark}"/></td>	
	...
	<s:a class="buttom-a" action="tuihuodanshenhe_shenhetongguo?purchaseBillVO.id=%{purchaseBillVO.id}">审核通过</s:a>
<s:a   class="buttom-a"  action="tuihuodanshenhe_tuichu">退出</s:a>
		</div>
   </div>
  </div>
