...
<script language="javascript">
	...
	function doDisabled(id){
		...
		ShowIframe("退款单反作废",url,600,260,"doDisabledCallback("+id+")");
	}
    ...
    <div class="modal-main search-business">
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" class="table-0">
			<tbody><tr>
				...
				<td style="width:33%;text-align:center" rowspan="2"><h2>退款单作废</h2></td>
		...
		<p class="give">
        	...
        	<span>时间：${purchaseBillExtVO.examineTime }</span>
			<span>帐套：${tallySetVO.title }</span>
		</p>
