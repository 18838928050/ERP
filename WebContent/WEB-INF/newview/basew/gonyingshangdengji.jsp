...
<title>供应商 | 管理易-广告加工制作管理软件  企业版 9.28  | 易凯软件</title>
...
<script language="javascript">
	...
	function doContactAdd(){
		...
		input.setAttribute("name","establishmentContactVOs["+contactNum+"].contactName");
	...
	function doCheck(){
		...
		if(checkKey!=""){
			var url="./EstablishmentCheck.html?type=PROVIDER&id=0&check_key="+checkKey;
	  	...
	  	<div class="msg-error" id="errorMsgDiv">
	    			...
	    			<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a2">
							<tbody><tr>
							    ...
							    <input type="text" maxlength="15" onkeyup="goNextInput(&#39;establishment.estName&#39;);" id="establishment.estCode" name="establishmentVO.estCode" value="${establishmentVO.estCode}" disabled="" class="TextBox readonly">
						          <script language="javascript">
						     	...
						     	<td>
						     		<input type="text" class="TextBox" maxlength="50" onkeyup="goNextInput(&#39;establishment.phone&#39;);" id="establishment.estName"value="${establishmentVO.estName}" name="establishmentVO.estName">
									<img class="make-a" src="${pageContext.request.contextPath}/images/make-c.gif" style="cursor:pointer;" onclick="doCheck(&#39;1&#39;);" title="查出哪些供应商是重名的，已删除的重名供应商可以在这里恢复">
							          <script language="javascript">
								...
								<th>经办人：</th>
						     	<td>
									...
									<input class="TextBox readonly" readonly="true" type="text" id="establishment.managerName" value="${establishmentVO.managerName}" name="establishmentVO.managerName">
									<img class="make-a" src="${pageContext.request.contextPath}/images/make-a.gif" style="cursor:pointer;" onclick="selectManager();">
							          <script language="javascript">
							          	setFormErrorMsg('',3);
							          </script>
							      
							      
									<input type="hidden" id="establishment.managerId" name="establishment.managerId" value="65">
				  ...
				  <fieldset class="det_fieldset "> <legend class="mag10">辅助信息</legend>
	    			<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a2">
								<tbody><tr>
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="20" onkeyup="goNextInput(&#39;establishment.fax&#39;);" id="establishment.phone"  value="${establishmentVO.phone}" name="establishmentVO.phone">
								          <script language="javascript">
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="20" onkeyup="goNextInput(&#39;establishment.email&#39;);" id="establishment.fax"  value="${establishmentVO.fax}" name="establishmentVO.fax"> 
								          <script language="javascript">
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="50" onkeyup="goNextInput(&#39;establishment.webSite&#39;);" id="establishment.email" value="${establishmentVO.email}" name="establishmentVO.email"> 
								          <script language="javascript">
							    ...
							    <tr>
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="50" onkeyup="goNextInput(&#39;establishment.postcode&#39;);" id="establishment.webSite" value="${establishmentVO.webSite}" name="establishmentVO.webSite">
								          <script language="javascript">
...
<option value="480">&nbsp;&nbsp;|--古城区</option>
							     	...
							     	<td>
							     		<input type="text" class="TextBox" maxlength="10" onkeyup="goNextInput(&#39;establishment.address&#39;);" id="establishment.postcode" value="${establishmentVO.postcode}" name="establishmentVO.postcode">
								          <script language="javascript">
							    ...
							    <tr>
							     	...
							     	<td colspan="5">
							     		<input type="text" class="TextBox" maxlength="50" onkeyup="goNextInput(&#39;establishment.bankName1&#39;);" style="width:390px" id="establishment.address" value="${establishmentVO.address}" name="establishmentVO.address">
								          <script language="javascript">
				  ...
				  <legend class="mag10">联系人</legend>				  
					...
					<input type="hidden" name="establishmentContactVOs[0].tmpCode" value="${tmpCode}">
								<tr id="contactTr0">
								<td>
										<input type="text" style="width:48px" class="TextBox" maxlength="15" id="contact_name_0" name="establishmentContactVOs[0].contactName" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<select id="sex_0" name="establishmentContactVOs[0].sex" onchange="checkContactChange(0);">
										   <option value="男">男</option>
										   <option value="女">女</option>
										</select>
									</td>
									<td>
										<input type="text" style="width:48px" class="TextBox" maxlength="15" id="possie_0" name="establishmentContactVOs[0].possie" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:82px" class="TextBox" maxlength="15" id="mobile_0" name="establishmentContactVOs[0].mobile" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:114px" class="TextBox" maxlength="50" id="email_0" name="establishmentContactVOs[0].email" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="18" id="phone_0" name="establishmentContactVOs[0].phone" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="25" id="im_0" name="establishmentContactVOs[0].im" value="" onchange="checkContactChange(0);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="100" id="mark_0" name="establishmentContactVOs[0].mark" value="" onchange="checkContactChange(0);">
									</td>
									<td>
								...
								<tr id="contactTr1">
									<td>
										<input type="text" style="width:48px" class="TextBox" maxlength="15" id="contact_name_1" name="establishmentContactVOs[1].contactName" value="" onchange="checkContactChange(1);">
									</td>
									<td>
									<!-- 	<input type="text" style="width:82px" class="TextBox" maxlength="15" id="mobile_1" name="establishmentContactVOs[0].sex" value="" onchange="checkContactChange(1);"> -->
										<select id="sex_1" name="establishmentContactVOs[0].sex" onchange="checkContactChange(1);">
										   <option value="男">男</option>
										   <option value="女">女</option>
										</select>
									</td>
										<td>
										<input type="text" style="width:48px" class="TextBox" maxlength="15" id="possie_2" name="establishmentContactVOs[1].possie"      value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:82px" class="TextBox" maxlength="15" id="mobile_2" name="establishmentContactVOs[1].mobile"          value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:114px" class="TextBox" maxlength="50" id="email_2" name="establishmentContactVOs[1].email"       value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="18" id="phone_2" name="establishmentContactVOs[1].phone"        value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="25" id="im_2"    name="establishmentContactVOs[1].im"           value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<input type="text" style="width:80px" class="TextBox" maxlength="100" id="mark_2" name="establishmentContactVOs[1].mark" value="" onchange="checkContactChange(2);">
									</td>
									<td>
								...
								<tr id="contactTr2">
									<td>
										<input type="text" style="width:48px" class="TextBox" maxlength="15" id="contact_name_2" name="contact_name_2" value="" onchange="checkContactChange(2);">
									</td>
									<td>
										<select id="sex_2" name="establishmentContactVOs[0].sex" onchange="checkContactChange(2);">
										   <option value="男">男</option>
										   <option value="女">女</option>
										</select>
									</td>
				  ...
				  <fieldset class="det_fieldset ">
					...
					<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a2">
						<tbody><tr>
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:160px" maxlength="50" onkeyup="goNextInput(&#39;establishment.bankAccCode1&#39;);" id="establishment.bankName1" value="${establishmentVO.bankName1}" name="establishmentVO.bankName1">
						          <script language="javascript">
						          	setFormErrorMsg('',15,'establishment.bankName1');
						          </script>
					     	</td>
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:180px" maxlength="50" onkeyup="goNextInput(&#39;establishment.bankAccName1&#39;);" id="establishment.bankAccCode1" value="${establishmentVO.bankAccCode1}" name="establishmentVO.bankAccCode1">
						          <script language="javascript">
						          	setFormErrorMsg('',16,'establishment.bankAccCode1');
						          </script>
					     	</td>
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:160px" maxlength="25" onkeyup="goNextInput(&#39;establishment.bankName2&#39;);" id="establishment.bankAccName1"  value="${establishmentVO.bankAccName1}" name="establishmentVO.bankAccName1">
						          <script language="javascript">
						          	setFormErrorMsg('',17,'establishment.bankAccName1');
						          </script>
					     	</td>
						...
						<tr>
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:160px" maxlength="50" onkeyup="goNextInput(&#39;establishment.bankAccCode2&#39;);" id="establishment.bankName2" value="${establishmentVO.bankName2}" name="establishmentVO.bankName2">
						          <script language="javascript">
						          	setFormErrorMsg('',18,'establishment.bankName2');
						          </script>
					     	</td>
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:180px" maxlength="50" onkeyup="goNextInput(&#39;establishment.bankAccName2&#39;);" id="establishment.bankAccCode2" value="${establishmentVO.bankAccCode2}" name="establishmentVO.bankAccCode2">
						          <script language="javascript">
						          	setFormErrorMsg('',19,'establishment.bankAccCode2');
						          </script>
					     	</td>
					     	...
					     	<td>
					     		<input type="text" class="TextBox" style="width:160px" maxlength="25" onkeyup="goNextInput(&#39;establishment.mark&#39;);" id="establishment.bankAccName2" value="${establishmentVO.bankAccName2}" name="establishmentVO.bankAccName2">
						          <script language="javascript">
						          	setFormErrorMsg('',20,'establishment.bankAccName2');
						          </script>
					     	</td>
				  ...
				  <legend class="mag10">备注</legend>
				  	<div style="padding:10px;">
							<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
								<tbody><tr>
									...
									<td>
									<br> 备注：我的ww<input type="text" value="${establishmentVO.mark}" name="establishmentVO.mark">
										<textarea class="TextBox" style="width:660px;height:80px" id="establishment.mark" value="${establishmentVO.mark}" name="establishmentVO.mark"></textarea>
								          <script language="javascript">
					...
					<div class="blank12">&nbsp;</div>
					<p class="give">
						<span>创建人：${ establishmentVO.createrName}</span>
						<span>创建时间：${ establishmentVO.createTime}</span>
						<span>所属帐套：${ tallySetVO.title}</span>
				          <script language="javascript">
				          	setFormErrorMsg('',1);
				          </script>
