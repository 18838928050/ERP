	  	...
	  	<div class="msg-error" id="errorMsgDiv">
				...
				<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
					<tbody><tr>
				      	...
				      	<td>
				      	<s:textfield  name="incomeType.typeName" value="%{incomeType.typeName}" type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;sequenceCode&#39;);" id="typeName" />
					...
					<tr>
				      	...
				      	<td>
				      	<s:textfield label="序号" name="incomeType.sequenceCode" value="%{incomeType.sequenceCode}"   class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode"></s:textfield>
				      		<!-- <input type="text" class="TextBox" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="3"> -->
