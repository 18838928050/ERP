...
<script language="javascript">
	...
	function doDisabled(id){
		...
		ShowIframe("退货单一览表审核",url,600,260,"doDisabledCallback("+id+")");
	}
...
<td><s:property value="%{purchaseBillItemVOs[#s.index].mark}"/></td>	
	...
	<s:a class="buttom-a" action="tuihuobiaoshenhe_shenhetongguo?purchaseBillVO.id=%{purchaseBillVO.id}">审核通过</s:a>
<s:a class="buttom-a" action="tuihuobiaoshenhe_tuichu">退出</s:a>
		</div>
   </div>
  </div>
