	...
	<head>
		...
		<script language="javascript">
			...
			function doExamineCallBack(id){
				if(popRetVal!=null){
					var url="storehouse/InBillExamine.html?id_str="+id+"&flag=0";
			...
			function doSearch(){
				...
				window.location="storehouse/InBillListForUnExamine.html?ts_id="+tsId+"&search_key="+searchKey;
			}
			function doGo(pageIndex){
				var searchKey=encodeURIComponent("");
				window.location="storehouse/InBillListForUnExamine.html?ts_id=1&search_key="+searchKey+"&current_page="+pageIndex;
			}
	      				...
	      				<div class="pull-right">
							<div class="layui-form" style=" display: inline-block;">
								<div class="layui-inline">
									...
									<a type="button " class="layui-btn " id="sDownloadButton " name="sDownloadButton " href="doDownload();">反审核</a>
							</div>
						</div>
	   			 </div>
			</div>
