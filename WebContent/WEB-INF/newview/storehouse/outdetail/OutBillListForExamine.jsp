...
<!-- saved from url=(0062)http://115.28.87.22:8888/storehouse/OutBillListForExamine.ihtm -->
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>出库单审核 | 管理易-广告加工制作管理软件 企业版 9.28 | 易凯软件</title>
		...
		<script language="javascript">
			...
			function doExamineCallBack(id) {
				if(popRetVal != null) {
					var url = "storehouse/OutBillExamine.html?id_str=" + id + "&flag=1";
					ShowIframe("出库单审核", url, 200, 200, "refreshWin()");
				}
			}
			...
			function doSearch() {
				...
				window.location = "storehouse/OutBillListForExamine.html?ts_id=" + tsId + "&search_key=" + searchKey;
			}

			function doGo(pageIndex) {
				var searchKey = encodeURIComponent("");
				window.location = "/storehouse/OutBillListForExamine.html?ts_id=1&search_key=" + searchKey + "&current_page=" + pageIndex;
			}
	...
	<body oncontextmenu="return false" onload="doInit();" class="sheet">
		...
		<div class="sheet-list">
			<div class="search-business">
				...
				<tr class="query_list_data_tr" index="1" style="cursor:pointer;" ondblclick="javascript:DoubleClick(this)" onclick="javascript:ClickCheck(this,true)" onmouseout="javascript:mouseout(this)" onmouseover="javascript:mouseover(this)">
				...
				<td>
					<a href="javascript:doExamine(&#39;125&#39;);">审核</a>
					<a href="javascript:doShow(&#39;125&#39;);">查看</a>
			    </td>
				</tr>
				</s:iterator>
				</tbody>
