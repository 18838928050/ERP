	...
	<head>
		...
		<script language="javascript">
			...
			function doReorder(id) {
				window.location = "InBillNew.html?alert_type=&data_type=COPY&template_id=" + id;
			}
			...
			function doPrint(id) {
				showWin(900, 600, "/storehouse/InBillPrint.html?id=" + id);
			}
			...
			function doUpload() {
				...
				if(storehouseId == "" || storehouseId == "0") {
					...
					ShowIframe("导入Excel", "/storehouse/InBillUploadForm.html?storehouse_id=" + storehouseId, 560, 300, "doUploadCallBack()");
				}
			}
			...
			function doUploadCallBack() {
				if(popRetVal) {
					...
					$.post("/storehouse/ImportInBillItem.html", {
						file_name: fileName
					}, function(data, status) {
