...
<!-- saved from url=(0056)http://115.28.87.22:8888/storehouse/OutBillItemList.html -->
...
<script language="javascript">
	function doShow(code){
		showWin(1024,600,"business/BusinessBillInfo.html?code="+encodeURIComponent(code));
	}
...
//			}
	...
	function doSearch(){
		...
		window.location="storehouse/OutBillItemList.html?"+str;
	}
	...
	function doDownload(){
		var str=getSearchCondition();
		window.location="/storehouse/OutBillItemList.html?content_type=EXCEL&"+str;
	}
