							...
							<div style="margin: 0 auto; width: 500px;">
								<div class="layui-form-item">
									...
									<div class="layui-input-inline">
										<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;oldPassword&#39;);" id="code" name="code" value="${makeRequire.code }">
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label"><span class="MustInput">*</span>制作要求：</label>
									<div class="layui-input-inline">
										<textarea style="width:280px;" placeholder="" class="layui-textarea" name="requireContent">${makeRequire.requireContent }</textarea>
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label"><span class="MustInput">*</span>附加单价：</label>
									<div class="layui-input-inline">
										<input class="layui-input" placeholder="" type="text" maxlength="15" onkeyup="goNextInput(&#39;confirmPassword&#39;);" id="price" name="price" value="${makeRequire.price }">
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label"><span class="MustInput">*</span>序号：</label>
									<div class="layui-input-inline">
										<input class="layui-input" placeholder="" type="text" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="${makeRequire.sequenceCode }">
									</div>
								</div>
							</div>
						</div>
