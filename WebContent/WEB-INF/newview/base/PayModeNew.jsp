...
<!-- saved from url=(0045)http://115.28.87.22:8888/base/PayModeNew.ihtm -->
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body oncontextmenu="return false" onload="showMe();" class="sheet modal-dialog">
		<div class="sheet-main" id="bodyDiv">
			<form name="frm" method="post" action="PayMode_doNew">
							...
							<table border="0" cellspacing="1" cellpadding="1" align="center" class="table-a">
								<tbody>
									<tr>
										...
										<td>
											<input type="text" class="layui-input" style="width: 140px;" maxlength="15" onkeyup="goNextInput(&#39;sequenceCode&#39;);" id="modeName" name="modeName" value="">
											<script language="javascript">
									...
									<tr>
										...
										<td>
											<input type="text" class="layui-input" style="width: 140px;" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="10">
