...
<html>
	...
	<body onload="doInit();" class="sheet modal-dialog" style="min-width: 1000px;">
		<div class="sheet-main" id="bodyDiv">
			<form class="layui-form" name="frm" method="post" action="customer_addCustomer">
						...
						<div style="width:100%;">
										...
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="15" onkeyup="goNextInput(establishment.estName);" id="establishment.estCode" name="establishment.estCode" disabled="" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 1, 'establishment.estCode');
												</script>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline" style="width: 130px;">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(establishment.phone);" id="establishment.estName" name="establishment.estName" value="">
													<script language="javascript">
														setFormErrorMsg('', 2, 'establishment.estName');
													</script>
												</div>
												<div class="layui-form-mid">
													<a href="javascript:doCheck('1');" title="查出哪些客户是重名的，已删除的重名客户可以在这里恢复">检查</a>
												</div>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline" style="width: 130px;">
													<input class="layui-input" readonly placeholder="" type="text" id="establishment.managerName" name="establishment.managerName" value="">
													<input type="hidden" id="establishment.managerId" name="establishment.managerId" value="-1">
													<script language="javascript">
														setFormErrorMsg('', 3);
													</script>
												</div>
									...
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<select id="establishment.estTypeId" name="establishment.estTypeId">
													...
													<script language="javascript">
														setFormErrorMsg('', 4, 'establishment.estTypeId');
													</script>
												</div>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<select id="establishment.estLevelId" name="establishment.estLevelId">
														<option value="0">==请选择==</option>
													...
													<script language="javascript">
														setFormErrorMsg('', 5, 'establishment.estLevelId');
													</script>
												</div>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													...
													<input class="layui-input" placeholder="" type="text" id="establishment.creditCost" name="establishment.creditCost" value="">
												</div>
											</div>
										</div>
									</div>
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline" style="width: 130px;">
													<input class="layui-input" readonly placeholder="" type="text" id="superiorName" name="superiorName" value="" title="设定客户的上级单位或总部，方便业务查询统计">
												</div>
												<div class="layui-form-mid">
													<a href="javascript:selectSuperior();">选择</a>
												</div>
												<div class="layui-form-mid">
													<a href="javascript:clearSuperior();">清除</a>
												</div>
												<script language="javascript">
													setFormErrorMsg('', 7);
												</script>
												<input type="hidden" id="establishment.superiorId" name="establishment.superiorId" value="0">
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<select id="establishment.payModeId" name="establishment.payModeId">
													<option value="0">==请选择==</option>
												...
												<script language="javascript">
													setFormErrorMsg('', 8, 'establishment.payModeId');
												</script>
												</div>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input type="radio" name="r_status" id="r_status1" onclick="changeStatus();" checked="" title="正常">
													<input type="radio" name="r_status" id="r_status2" onclick="changeStatus();" title="停用">
												<input type="hidden" name="establishment.status" id="establishment.status" value="Y">
												</div>
											</div>
										</div>
									</div>
							...
							<fieldset class="layui-elem-field layui-field-title">
								...
								<div class="layui-field-box">
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="20" onkeyup="goNextInput(&#39;establishment.fax&#39;);" id="establishment.phone" name="establishment.phone" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 7, 'establishment.phone');
												</script>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="20" onkeyup="goNextInput(&#39;establishment.email&#39;);" id="establishment.fax" name="establishment.fax" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 8, 'establishment.phone');
												</script>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.webSite&#39;);" id="establishment.email" name="establishment.email" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 9, 'establishment.phone');
												</script>
											</div>
										</div>
									</div>
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.postcode&#39;);" id="establishment.webSite" name="establishment.webSite" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 10, 'establishment.webSite');
												</script>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<select id="establishment.areaId" name="establishment.areaId" style="width:140px">
													<option value="0">==请选择==</option>
												...
												<script language="javascript">
													setFormErrorMsg('', 11, 'establishment.areaId');
												</script>
												</div>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="10" onkeyup="goNextInput(&#39;establishment.address&#39;);" id="establishment.postcode" name="establishment.postcode" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 12, 'establishment.postcode');
												</script>
											</div>
										</div>
									</div>
									<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.mark&#39;);" style="width:390px" id="establishment.address" name="establishment.address" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 13, 'establishment.address');
												</script>
											</div>
								</div>
							</fieldset>
							<fieldset class="layui-elem-field layui-field-title">
								...
								<div class="layui-field-box">
									...
									<input type="hidden" name="contact_num" id="contact_num" value="3">
									<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" id="contactTbl">
										<tbody id="contactRowTbl">
											...
											<tr id="contactTr0">
												<td>
													<input type="text" style="width:48px" class="TextBox" maxlength="15" id="contact_name_0" name="establishmentContact[0].contactName" value="" onchange="checkContactChange(0);">
												</td>
												<td>
													<select id="sex_0" name="establishmentContact[0].sex" onchange="checkContactChange(0);">
														<option value="男">男</option>
														<option value="女">女</option>
													</select>
												</td>
												<td>
													<input type="text" style="width:48px" class="TextBox" maxlength="15" id="possie_0" name="establishmentContact[0].possie" value="" onchange="checkContactChange(0);">
												</td>
												<td>
													<input type="text" style="width:82px" class="TextBox" maxlength="15" id="mobile_0" name="establishmentContact[0].mobile" value="" onchange="checkContactChange(0);">
												</td>
												<td>
													<input type="text" style="width:114px" class="TextBox" maxlength="50" id="email_0" name="establishmentContact[0].email" value="" onchange="checkContactChange(0);">
												</td>
												<td>
													<input type="text" style="width:80px" class="TextBox" maxlength="18" id="phone_0" name="establishmentContact[0].phone" value="" onchange="checkContactChange(0);">
												</td>
												<td>
													<input type="text" style="width:80px" class="TextBox" maxlength="25" id="im_0" name="establishmentContact[0].im" value="" onchange="checkContactChange(0);">
												</td>
												<td>
													<input type="text" style="width:80px" class="TextBox" maxlength="100" id="mark_0" name="establishmentContact[0].mark" value="" onchange="checkContactChange(0);">
												</td>
												<td>
													<input lay-skin="primary" type="checkbox" id="is_main_0" name="establishmentContact[0].isMain" value="1" onchange="checkContactChange(0);">
												</td>
												<td>
													<a href="javascript:doContactDelete(0);">删除</a>
											...
											<tr id="contactTr1">
												<td>
													<input type="text" style="width:48px" class="TextBox" maxlength="15" id="contact_name_1" name="establishmentContact[1].contactName" value="" onchange="checkContactChange(1);">
												</td>
												<td>
													<select id="sex_1" name="establishmentContact[1].sex" onchange="checkContactChange(1);">
														<option value="男">男</option>
														<option value="女">女</option>
													</select>
												</td>
												<td>
													<input type="text" style="width:48px" class="TextBox" maxlength="15" id="possie_1" name="establishmentContact[1].possie" value="" onchange="checkContactChange(1);">
												</td>
												<td>
													<input type="text" style="width:82px" class="TextBox" maxlength="15" id="mobile_1" name="establishmentContact[1].mobile" value="" onchange="checkContactChange(1);">
												</td>
												<td>
													<input type="text" style="width:114px" class="TextBox" maxlength="50" id="email_1" name="establishmentContact[1].email" value="" onchange="checkContactChange(1);">
												</td>
												<td>
													<input type="text" style="width:80px" class="TextBox" maxlength="18" id="phone_1" name="establishmentContact[1].phone" value="" onchange="checkContactChange(1);">
												</td>
												<td>
													<input type="text" style="width:80px" class="TextBox" maxlength="25" id="im_1" name="establishmentContact[1].im" value="" onchange="checkContactChange(1);">
												</td>
												<td>
													<input type="text" style="width:80px" class="TextBox" maxlength="100" id="mark_1" name="establishmentContact[1].mark" value="" onchange="checkContactChange(1);">
												</td>
												<td>
													<input lay-skin="primary" type="checkbox" id="is_main_1" name="establishmentContact[1].isMain" value="1" onchange="checkContactChange(1);">
												</td>
												<td>
													<a href="javascript:doContactDelete(1);">删除</a>
													<input type="hidden" id="status_1" name="status_1" value="UNCHANGE">
													<input type="hidden" id="id_1" name="id_1" value="0">
												</td>
											</tr>

											<tr id="contactTr2">
												<td>
													<input type="text" style="width:48px" class="TextBox" maxlength="15" id="contact_name_2" name="establishmentContact[2].contactName" value="" onchange="checkContactChange(2);">
												</td>
												<td>
													<select id="sex_2" name="sex_2" onchange="checkContactChange(2);">
														<option value="男">男</option>
														<option value="女">女</option>
													</select>
												</td>
												<td>
													<input type="text" style="width:48px" class="TextBox" maxlength="15" id="possie_2" name="establishmentContact[2].possie" value="" onchange="checkContactChange(2);">
												</td>
												<td>
													<input type="text" style="width:82px" class="TextBox" maxlength="15" id="mobile_2" name="establishmentContact[2].mobile" value="" onchange="checkContactChange(2);">
												</td>
												<td>
													<input type="text" style="width:114px" class="TextBox" maxlength="50" id="email_2" name="establishmentContact[2].email" value="" onchange="checkContactChange(2);">
												</td>
												<td>
													<input type="text" style="width:80px" class="TextBox" maxlength="18" id="phone_2" name="establishmentContact[2].phone" value="" onchange="checkContactChange(2);">
												</td>
												<td>
													<input type="text" style="width:80px" class="TextBox" maxlength="25" id="im_2" name="establishmentContact[2].im" value="" onchange="checkContactChange(2);">
												</td>
												<td>
													<input type="text" style="width:80px" class="TextBox" maxlength="100" id="mark_2" name="establishmentContact[2].mark" value="" onchange="checkContactChange(2);">
												</td>
												<td>
													<input lay-skin="primary" type="checkbox" id="is_main_2" name="establishmentContact[2].isMain" value="1" onchange="checkContactChange(2);">
												</td>
												<td>
													<a href="javascript:doContactDelete(2);">删除</a>
													<input type="hidden" id="status_2" name="status_2" value="UNCHANGE">
													<input type="hidden" id="id_2" name="id_2" value="0">
												</td>
											</tr>
									...
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.invoCode&#39;);" id="establishment.invoName" name="establishment.invoName" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 15, 'establishment.invoName');
												</script>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label" style="padding-left: 0; width: 85px;">纳税识别号：</label>
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="25" onkeyup="goNextInput(&#39;establishment.invoAddr&#39;);" id="establishment.invoCode" name="establishment.invoCode" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 16, 'establishment.invoCode');
												</script>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="100" onkeyup="goNextInput(&#39;establishment.invoBankName&#39;);" id="establishment.invoAddr" name="establishment.invoAddr" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 17, 'establishment.invoAddr');
												</script>
											</div>
										</div>
									</div>
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.invoBankCode&#39;);" id="establishment.invoBankName" name="establishment.invoBankName" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 18, 'establishment.invoBankName');
												</script>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<input class="layui-input" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;establishment.invoBankCode&#39;);" id="establishment.invoBankCode" name="establishment.invoBankCode" value="">
												</div>
												<script language="javascript">
													setFormErrorMsg('', 19, 'establishment.invoBankCode');
												</script>
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												...
												<div class="layui-input-inline">
													<select id="establishment.invoType" name="establishment.invoType">
													<option value="">==请选择==</option>
													<option value="POPU">普通票</option>
													<option value="SPEC">专用票</option>
												</select>
												</div>
												<script language="javascript">
													setFormErrorMsg('', 19, 'establishment.invoBankCode');
							...
							<fieldset class="layui-elem-field layui-field-title">
								...
								<div class="layui-field-box">
									<div class="layui-row">
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label" style="padding-left: 0; width: 85px;">业务单打印：</label>
												<div class="layui-input-inline" style="width: 200px;">
													<input type="radio" name="r_busi_pphone" id="r_busi_pphone1" onclick="changeBusiPphone();" value="0" title="显示（联系人、电话、地址）" checked>
													<input type="radio" name="r_busi_pphone" id="r_busi_pphone2" onclick="changeBusiPphone();" value="1" title="隐藏（联系人、电话、地址）">
												</div>
												
												<input type="hidden" name="establishment.busiPphone" id="establishment.busiPphone" value="Y">
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label" style="padding-left: 0; width: 85px;">送货单打印：</label>
												<div class="layui-input-inline" style="width: 200px;">
													<input type="radio" name="r_deli_pphone" id="r_deli_pphone1" onclick="changeDeliPphone();" value="0" title="显示（联系人、电话、地址）" checked>
													<input type="radio" name="r_deli_pphone" id="r_deli_pphone2" onclick="changeDeliPphone();" value="1" title="隐藏（联系人、电话、地址）">
												</div>
												
												<input type="hidden" name="establishment.deliPphone" id="establishment.deliPphone" value="Y">
											</div>
										</div>
										<div class="layui-col-sm4">
											<div class="layui-form-item">
												<label class="layui-form-label" style="padding-left: 0; width: 85px;">制作单打印：</label>
												<div class="layui-input-inline" style="width: 200px;">
													<input type="radio" name="r_make_pphone" id="r_make_pphone1" onclick="changeMakePphone();" value="0" title="显示（联系人、电话、地址）">
													<input type="radio" name="r_make_pphone" id="r_make_pphone2" onclick="changeMakePphone();" value="1" title="隐藏（联系人、电话、地址）" checked="">
												</div>
												
												<input type="hidden" name="establishment.makePphone" id="establishment.makePphone" value="N">
											</div>
										</div>
									</div>
								</div>
							...
							<fieldset class="layui-elem-field layui-field-title">
								<legend>备注</legend>
								<div class="layui-field-box">
									<textarea id="establishment.mark" name="establishment.mark" placeholder="" class="layui-textarea"></textarea>
													<script language="javascript">
														setFormErrorMsg('', 21, 'establishment.mark');
													</script>
								</div>
							</fieldset>
				...
				<div class="modal-buttom" id="buttonDiv">
					...
					<input type="button" class="buttom-a" value="保存并新增" onclick="doSave('0');">
		...
		<script>
			...
			function doCheck() {
				...
				if(checkKey != "") {
					var url = "./EstablishmentCheck.html?type=CLIENT&id=0&check_key=" + checkKey;
					ShowIframe(['600px','500px'], url, '', '', '名称检查');
				} else {
					ShowAlert('请填写名称', {title:'提示'});
				}
			}
			...
			function selectManager() {
				...
				ShowIframe(['800px','500px'], url, '', function callBack(){
			...
			function selectSuperior() {
				var url = "./EstablishmentListForSelect.html?type=CLIENT&show_all=Y";
				ShowIframe(['900px','500px'], url, '', function callBack(){
					selectSuperiorCallBack();
				},'选择上级');
			}
