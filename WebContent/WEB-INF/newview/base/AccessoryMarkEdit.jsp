							...
							<div style="margin: 0 auto; width: 440px;">
								<div class="layui-form-item">
									...
									<div class="layui-input-inline">
										<input class="layui-input" style="width:260px" placeholder="" type="text" maxlength="50" onkeyup="goNextInput(&#39;sequenceCode&#39;);" id="mark" name="mark" value="${accessoryMark.mark }">
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label"><span class="MustInput">*</span>序号：</label>
									<div class="layui-input-inline">
										<input class="layui-input" placeholder="" type="text" maxlength="15" onkeyup="goNextInput(&#39;&#39;);" id="sequenceCode" name="sequenceCode" value="${accessoryMark.sequenceCode }">
									</div>
								</div>
							</div>
						</div>
