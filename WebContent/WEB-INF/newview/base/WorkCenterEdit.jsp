...
<!-- saved from url=(0054)http://115.28.87.22:8888/base/WorkCenterEdit.ihtm?id=1 -->
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body oncontextmenu="return false" onload="showMe();" class="sheet modal-dialog">
		<div class="sheet-main" id="bodyDiv">
			<form name="frm" action="WorkCenter_doEdit" method="post">
			<input hidden value="${workCenter.id }" name="id" />
							...
							<table style="margin-bottom: 0;" border="0" cellspacing="1" cellpadding="1" align="center" class="table-a layui-form">
								<tbody>
									<tr>
										...
										<td>
											<input class="layui-input" style="width: 140px;" type="text" maxlength="15" onkeyup="goNextInput(&#39;mark&#39;);" id="wcName" name="wcName" value="${workCenter.wcName }">
											<script language="javascript">
									...
									<tr>
										...
										<td>
											<input class="layui-input" style="width: 140px;" type="text" maxlength="50" id="mark" name="mark" value="${workCenter.mark }">
											<script language="javascript">
										...
										<td>
											<div class="layui-inline" style="width: 140px;">
												...
												<s:iterator value="storehouses" status="indexs">
													<option <c:if test="${workCenter.storehouseId == id }">selected</c:if> value="${id }">${stoName }</option>
												</s:iterator>
									...
									<tr>
										...
										<td>
											<input type="radio" name="r_status" id="r_status1" onclick="changeStatus();" value="正常" title="正常" 
											<c:if test="${workCenter.enabled == 'Y'}">checked</c:if>
											>
											<input type="radio" name="r_status" id="r_status2" onclick="changeStatus();" value="停用" title="停用"
											<c:if test="${workCenter.enabled == 'N'}">checked</c:if>
											>

											<input type="hidden" name="status" id="status" value="${workCenter.enabled }">
