...
<head>
	...
	<script language="javascript">
		function doTreeNodeClick(id) {
			...
			parent.document.getElementById("mainFrame").src = "Business_findStaffer?id="+id;
		}
		var normalHeight = 0;
...
<body onload="doInit();" style="text-align:center" scroll="no">
	<div class="nav" id="scrollDiv" style="text-align:left;overflow-x:hidden;overflow-y:auto;height:348px;">
		...
		<div class="nav-link nav-mail" style="width:100%">
			...
			<script language="javascript">
				...
				<s:iterator value="departments">
					d.add(${id}, ${parentId}, '${departmentName}', "javascript:doTreeNodeClick('${id}');", '', '', '', false);
				</s:iterator>
				document.write(d);
				d.closeAll();
			</script>
