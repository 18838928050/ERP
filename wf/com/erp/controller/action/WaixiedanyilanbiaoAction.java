...
>>>>>>> b25985936a1f1c8766072b68e1f73147c93e8f66
...
<<<<<<< HEAD
	public String findAll() {
		...
		String sql = "SELECT        " + "CB.bill_code AS a,          "
				+ "CB.cooper_date AS b,        " + "E.est_name AS c,            "
				+ "CB.content AS d,            " + "CB.cost AS f,               "
				+ "CBE.adjust_cost AS g,       " + "CBE.paied_cost AS h,        "
				+ "CB.manager_name AS j,       " + "CB.creater_name AS k,       "
				+ "CBE.examined AS l,          " + "CBE.has_gather AS m,        "
				+ "CBE.has_pay AS n            " + "FROM                        "
				+ "	cooper_bill AS CB,        " + "	establishment AS E,       "
				+ "	cooper_bill_ext AS CBE    " + "WHERE                       "
				+ "CB.tally_set_id = 2 AND     " + "CB.id = CBE.id AND          "
				+ "CB.cooperator_id = E.id AND " + "CBE.examined = 'N' AND      "
				+ "CBE.enabled = 'Y'               ";
